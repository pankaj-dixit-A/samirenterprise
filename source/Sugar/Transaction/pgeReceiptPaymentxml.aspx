                ...
                <table width="90%" align="center">
                    ...
                    <tr>
                        ...
                        <td align="left" colspan="4">
                            <asp:TextBox ID="txtUnit_Code" runat="Server" CssClass="txt" TabIndex="15" Width="80px"
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <asp:DropDownList ID="drpFilter" runat="server" CssClass="ddl" Width="280px" Height="25px"
                                Visible="true" AutoPostBack="true" TabIndex="16" OnSelectedIndexChanged="drpFilter_SelectedIndexChanged"
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <asp:TextBox ID="txtVoucherNo" Height="24px" runat="Server" CssClass="txt" Width="80px" Enabled="false"
                                onkeydown="voucherno(event);" Style="text-align: right;" TabIndex="17" AutoPostBack="false" OnTextChanged="txtVoucherNo_TextChanged"></asp:TextBox>
                            <asp:Button ID="btntxtVoucherNo" runat="server" Text="..." OnClick="btntxtVoucherNo_Click"
                                TabIndex="18" CssClass="btnHelp" Height="24px" Width="20px" />
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <asp:TextBox ID="txtamount" runat="Server" TabIndex="5" Height="24px" CssClass="txt"
                            ...
                            <asp:TextBox ID="txtadAmount" runat="Server" CssClass="txt" Height="24px" Width="80px"
                                Style="text-align: right;" AutoPostBack="false" TabIndex="110" OnTextChanged="txtadAmount_TextChanged"></asp:TextBox>
                            ...
                            <asp:TextBox ID="txtacadjamt" Height="24px" runat="Server" CssClass="txt" Width="80px"
                                Style="text-align: right;" TabIndex="111"></asp:TextBox>
                            Adjusted AC Code:
                        
                            <asp:TextBox ID="txtacadjAccode" runat="Server" CssClass="txt" Width="80px" Style="text-align: right;"
                                onkeydown="acadjaccode(event);" TabIndex="112" AutoPostBack="false" OnTextChanged="txtacadjAccode_TextChanged" Height="24px"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <asp:TextBox ID="txtTDSRate" runat="Server" TabIndex="113" Height="24px" CssClass="txt"
                            ...
                            <asp:TextBox ID="txtTDSAmt" runat="Server" CssClass="txt" Height="24px" Width="80px"
                                Style="text-align: right;" AutoPostBack="false" TabIndex="114" OnTextChanged="txtTDSAmt_TextChanged"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <asp:TextBox ID="txtnarration" runat="Server" CssClass="txt" Width="480px" Height="50px"
                                onkeydown="narration(event);" TextMode="MultiLine" Style="text-align: left;" AutoPostBack="True" TabIndex="6"
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <asp:TextBox ID="txtNarration2" runat="Server" CssClass="txt" Width="480px" Height="24px"
                                Style="text-align: left;" AutoPostBack="True" TabIndex="116" OnTextChanged="txtNarration2_TextChanged"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td align="left">GRN
                        ...
                        <td align="left">
                            <asp:TextBox ID="txtGRN" runat="Server" CssClass="txt" Width="480px" Height="24px"
                                Style="text-align: left;" TabIndex="116"></asp:TextBox>
                    ...
                    <tr>
                        <td colspan="2" align="left">
                            <asp:Button ID="btnAdddetails" runat="server" Text="ADD" CssClass="btnHelp" Width="80px"
                                Height="24px" OnClick="btnAdddetails_Click" TabIndex="7" />
                            <asp:Button ID="btnClosedetails" runat="server" Text="Close" CssClass="btnHelp"
                                Height="24px" Width="80px" OnClick="btnClosedetails_Click" TabIndex="8" />
                        </td>
                    </tr>
                </table>
            </asp:Panel>
