    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (hdnfClosePopup.Value == "txtlotno_Detail")
            {
                ...
                {
                    qry = "select Tender_No,Tender_DateConverted as Tender_Date,Quantal,Mill_Rate ,millamount,paidamount,payableamount,Year_Code,Grade,millshortname from qrymillpaymentbalance"
                       + " where Company_Code=" + Convert.ToInt32(Session["Company_Code"].ToString()) + " and payableamount !=0 and Payment_To=" + txtmill_code.Text;
                }
                else
                {
