...
public partial class Sugar_Transaction_pgeJournal_Voucher : System.Web.UI.Page
{
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
     ...
     " where Tran_Type='JV' and doc_date =(select max(doc_date) from " + tblHead +
     " where Tran_Type='JV' and Year_Code=" + Convert.ToString(Session["year"]).ToString()
   + " and Company_Code=" + Convert.ToInt32(Session["Company_Code"]).ToString()
   + " and Doc_No=(select max(Doc_No) from " + tblHead + " where Tran_Type='JV' and Year_Code=" + Convert.ToString(Session["year"]).ToString() +
   ...
   + " and Company_Code=" + Convert.ToInt32(Session["Company_Code"]).ToString();
    ...
    private string getDisplayQuery()
    {
        try
        {
            string qryDisplay = "select * from " + qryCommon + " where tranid=" + hdnf.Value +
                " and Company_Code=" + Convert.ToInt32(Session["Company_Code"].ToString()) + " and Year_Code=" + Convert.ToInt32(Session["year"].ToString()) + 
