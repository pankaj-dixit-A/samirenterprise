<%@ Page Title="Journal Voucher" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="pgeJournal_Voucher.aspx.cs" Inherits="Sugar_Transaction_pgeJournal_Voucher" %>
            ...
            function OnSuccess(response) {
                ...
                if (status != "Delete") {
                    if (response.d.length > 0) {
                        ...
                        window.open('../Transaction/pgeJournal_Voucher.aspx?tranid=' + id + '&Action=1', "_self");
                ...
                <table width="80%" align="left">
                    <tr>
                        ...
                        <asp:Button ID="btnSave" OnClientClick="if (!Validate()) return false;" runat="server" Text="Save" CssClass="btnHelp" Width="90px"
                            ValidationGroup="add" OnClick="btnSave_Click"  TabIndex="10" Height="24px" />
                            &nbsp;
                        <asp:Button ID="btnEdit" runat="server" Text="Edit" CssClass="btnHelp"  TabIndex="11" Width="90px"
                            ValidationGroup="save" OnClick="btnEdit_Click" Height="24px" />
                            &nbsp;
                        <asp:Button ID="btnDelete" runat="server" Text="Delete" CssClass="btnHelp" Width="90px"
                            ValidationGroup="add" OnClick="btnDelete_Click" OnClientClick="Confirm()"  TabIndex="12" Height="24px" />
                            &nbsp;
                        <asp:Button ID="btnCancel" runat="server" Text="Cancel" CssClass="btnHelp"  TabIndex="13" Width="90px"
                            ValidationGroup="save" OnClick="btnCancel_Click" Height="24px" />
                            &nbsp;
                            <asp:Button ID="btnBack" runat="server" Text="Back" CssClass="btnHelp"  TabIndex="14" Width="90px"
