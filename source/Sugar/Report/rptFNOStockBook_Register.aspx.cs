...
using System.Data.SqlClient;
public partial class Sugar_Report_rptFNOStockBook_Register : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (isAuthenticate == "1" || User_Type == "A")
            {
                ...
                pagehead = "FNO StockBook Register from " + fromdt + " To " + todt;
                ...
                rprt1.Load(Server.MapPath("CryFNOStockBook_Register.rpt"));
                rprt1.SetDataSource(dt);
                CryFNOStockBook_Register.ReportSource = rprt1;
    ...
    private DataTable GetData(string fromdt, string todt)
    {
        ...
        using (SqlConnection con = new SqlConnection(strcon))
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("select * from QryFutureTranstion where doc_date between '" + datefrom + "' and '" + dateto + "' and AutoCarry='N' and Company_Code=" + Convert.ToInt32(Session["Company_Code"].ToString()) + " and Year_Code=" + Convert.ToInt32(Session["year"].ToString()), con);
            ...
            {
                SqlCommand cmd = new SqlCommand("select * from QryFutureTranstion where doc_date between '" + datefrom + "' and '" + dateto + "'  and AC_Code='" + Accode +
                    "' and AutoCarry='N' and Company_Code=" + Convert.ToInt32(Session["Company_Code"].ToString()) + " and Year_Code=" + Convert.ToInt32(Session["year"].ToString()), con);
                cmd.CommandType = CommandType.Text;
                SqlDataAdapter sda = new SqlDataAdapter(cmd);
                sda.Fill(dt);
            }
    ...
    protected void btnPDF_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string filename = filepath + "\\FNOStockBookRegister" + company_code + "_" + year_code + "_" + DateTime.Now.ToString("ddMMyyyy_HHmmss") + ".pdf";
    ...
    protected void btnMail_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string filename = filepath + "\\FNOStockBookRegister_" + company_code + "_" + year_code + "_" + DateTime.Now.ToString("ddMMyyyy_HHmmss") + ".pdf";
            rprt1.ExportToDisk(CrystalDecisions.Shared.ExportFormatType.PortableDocFormat, filename);
            ...
            if (txtEmail.Text != string.Empty)
            {
                ...
                contentType.Name = "FNOStockBookRegister";
    ...
    protected void Page_Unload(object sender, EventArgs e)
    {
        ...
        //rprt1.Dispose();
        //GC.Collect();
        this.CryFNOStockBook_Register.ReportSource = null;

        CryFNOStockBook_Register.Dispose();
