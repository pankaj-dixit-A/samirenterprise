...
public partial class Sugar_Report_rptShortLongTerm : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (isAuthenticate == "1" || User_Type == "A")
            {
                ...
                pagehead = "Short Term Long Term Profit & Loss Report from " + fromdt + " To " + todt;
                ...
                rprt1.Load(Server.MapPath("CryShortLongTerm.rpt"));
                rprt1.SetDataSource(dt);
                CryShortLongTerm.ReportSource = rprt1;
    ...
    private DataTable GetData(string fromdt, string todt)
    {
        ...
        using (SqlConnection con = new SqlConnection(strcon))
        {
            ...
            SqlCommand cmd = new SqlCommand("select * from qryEquityShortlongterm where Company_Code=" + Convert.ToInt32(Session["Company_Code"].ToString()) + 
    ...
    protected void Page_Unload(object sender, EventArgs e)
    {
        ...
        //rprt1.Dispose();
        //GC.Collect();
        this.CryShortLongTerm.ReportSource = null;

        CryShortLongTerm.Dispose();
