...
public partial class Sugar_Report_rptMillCashDiff : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (isAuthenticate == "1" || User_Type == "A")
            {
                ...
                pagehead = "Mill Cash Diff Report from " + fromdt + " To " + todt;
                ...
                rprt1.Load(Server.MapPath("CryMillCashDiff.rpt"));
                rprt1.SetDataSource(dt);
                CryMillCashDiff.ReportSource = rprt1;
    ...
    private DataTable GetData(string fromdt, string todt)
    {
        ...
        using (SqlConnection con = new SqlConnection(strcon))
        {
            ...
            {
                cmd = new SqlCommand("select * from qrytenderhead where  Company_Code=" + company_code + " and CashDiff!='0'  and Year_Code=" + year_code + " and Tender_Date between '" + datefrom + "' and '" + dateto + "'", con);

            }

            else
            {
                cmd = new SqlCommand("select * from qrytenderhead where Broker= '" + Accode + "' and CashDiff!='0' and  Company_Code=" + company_code + " and Year_Code=" + year_code + " and Tender_Date between '" + fromdt + "' and '" + todt + "'", con);
            }
    ...
    protected void Page_Unload(object sender, EventArgs e)
    {
        ...
        //rprt1.Dispose();
        //GC.Collect();
        this.CryMillCashDiff.ReportSource = null;

        CryMillCashDiff.Dispose();
