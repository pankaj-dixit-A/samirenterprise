                    ...
                    <table width="100%" cellspacing="5">
                        ...
                        <tr>
                            <td align="left">Unit Code: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <asp:TextBox ID="txtUnitCode" runat="server" Width="80px" CssClass="txt" AutoPostBack="false"
            ...
            <td colspan="4">
                <table align="center" width="60%" cellspacing="5" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <asp:Button runat="server" ID="btndaybookhtmll" Text="Day Book New " CssClass="btnHelp" Width="130px"
                    ...
                    <tr>
                        ...
                        <td align="left">
                            ...
                            <asp:Button runat="server" ID="btncashdiffledger" Text="Cash Diff Ledger" CssClass="btnHelp"
                        ...
                        <td align="left">
                            <asp:Button runat="server" ID="btnmultipleourdono" Text="Multiple DO" CssClass="btnHelp"
                                Width="180px" Height="24px" OnClick="btnmultipleourdono_Click" />
                        </td>
                    </tr>
                </table>
            </td>
