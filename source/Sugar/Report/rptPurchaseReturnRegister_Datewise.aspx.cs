...
public partial class Report_rptPurchaseReturnRegister_Datewise : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (isAuthenticate == "1" || User_Type == "A")
            {
                ...
                pagehead = "Purchase Return Register from " + fromdt + " To " + todt;
                ...
                rprt1.Load(Server.MapPath("CryPurchaseReturnRegister.rpt"));
                rprt1.SetDataSource(dt);
                CryPurchaseReturnRegister.ReportSource = rprt1;
    ...
    private DataTable GetData(string fromdt, string todt)
    {
        ...
        using (SqlConnection con = new SqlConnection(strcon))
        {
            ...
            SqlCommand cmd = new SqlCommand("select * from qrysugarpurchasereturnhead where doc_date between '" + datefrom + "' and '" + dateto + "'", con);
    ...
    protected void Page_Unload(object sender, EventArgs e)
    {
        ...
        //rprt1.Dispose();
        //GC.Collect();
        this.CryPurchaseReturnRegister.ReportSource = null;

        CryPurchaseReturnRegister.Dispose();
