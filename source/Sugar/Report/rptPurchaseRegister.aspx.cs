...
public partial class Sugar_Report_rptPurchaseRegister : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (isAuthenticate == "1" || User_Type == "A")
            {
                ...
                pagehead = "Purchase Register from " + fromdt + " To " + todt;
                ...
                rprt1.Load(Server.MapPath("CryPurchaseRegister.rpt"));
    ...
    private DataTable GetData(string fromdt, string todt)
    {
        ...
        using (SqlConnection con = new SqlConnection(strcon))
        {
            if (Accode != "0")
            {
                SqlCommand cmd = new SqlCommand("select * from qrypurchasehead where doc_date between '" + datefrom + "' and '" + dateto + "'and Ac_Code='" + Accode + "'", con);
            ...
            else
            {
                ...
                SqlCommand cmd = new SqlCommand("select * from qrypurchasehead where doc_date between '" + datefrom + "' and '" + dateto + "'", con);
                cmd.CommandType = CommandType.Text;
                SqlDataAdapter sda = new SqlDataAdapter(cmd);
                sda.Fill(dt);
            }
