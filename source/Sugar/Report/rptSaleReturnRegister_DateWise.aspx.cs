...
public partial class Report_rptSaleReturnRegister_DateWise : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (isAuthenticate == "1" || User_Type == "A")
            {
                ...
                pagehead = "Sale Return Register from " + fromdt + " To " + todt;
                ...
                rprt1.Load(Server.MapPath("CrySaleReturnRegister.rpt"));
                rprt1.SetDataSource(dt);
                CrySaleReturnRegister.ReportSource = rprt1;
    ...
    private DataTable GetData(string fromdt, string todt)
    {
        ...
        using (SqlConnection con = new SqlConnection(strcon))
        {
            ...
            SqlCommand cmd = new SqlCommand("select * from qrysugarsalereturnhead where doc_date between '" + datefrom + "' and '" + dateto + "'", con);
    ...
    protected void Page_Unload(object sender, EventArgs e)
    {
        ...
        //rprt1.Dispose();
        //GC.Collect();
        this.CrySaleReturnRegister.ReportSource = null;

        CrySaleReturnRegister.Dispose();
