...
public partial class Sugar_Report_rptFNO : System.Web.UI.Page
{
    ...
    protected void btnPurchaseSaleReport_Click(object sender, EventArgs e)
    {
        string ac_code = txtAcCode.Text;
        string fromDT = "";
        string toDT = "";
        ...
        ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "ku", "javascript:prsale('" + fromDT + "','" + toDT + "','" + ac_code + "')", true);
        pnlPopup.Style["display"] = "none";
    }
