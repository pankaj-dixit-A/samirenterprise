...
public partial class Sugar_Report_rptRCM : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (isAuthenticate == "1" || User_Type == "A")
            {
                ...
                pagehead = "Reverse Charge Report from " + fromdt + " To " + todt;
                ...
                rprt1.Load(Server.MapPath("CryRCM.rpt"));
                rprt1.SetDataSource(dt);
                CryRCM.ReportSource = rprt1;
    ...
    private DataTable GetData(string fromdt, string todt)
    {
        ...
        using (SqlConnection con = new SqlConnection(strcon))
        {
            ...
            cmd = new SqlCommand("select * from qryRCM where doc_date between '" + datefrom + "' and '" + dateto + "'", con);
