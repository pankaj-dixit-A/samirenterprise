...
public partial class Sugar_Report_rptDateWiseSaleRegisterforMill : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (isAuthenticate == "1" || User_Type == "A")
            {
                ...
                pagehead = "Datewise Mill Register from " + fromdt + " To " + todt;
                ...
                rprt1.Load(Server.MapPath("CryDateWiseSaleRegisterforMill.rpt"));
                rprt1.SetDataSource(dt);
                CryDateWiseSaleRegisterforMill.ReportSource = rprt1;
    ...
    private DataTable GetData(string fromdt, string todt, string accode)
    {
        ...
        using (SqlConnection con = new SqlConnection(strcon))
        {
            ...
            if (Accode == "0")
            {
                cmd = new SqlCommand("select * from qrysaleheaddetail where doc_date between '" + datefrom + "' and '" + dateto + "' and IsDeleted !='0'  and doc_no !='0' ", con);
            }
            else
            {
                cmd = new SqlCommand("select * from qrysaleheaddetail where doc_date  between '" + datefrom + "' and '" + dateto + "' and mill_code= '" + Accode + "' and IsDeleted !='0'  and doc_no !='0'", con);
            }
    ...
    protected void Page_Unload(object sender, EventArgs e)
    {
        ...
        //rprt1.Dispose();
        //GC.Collect();
        this.CryDateWiseSaleRegisterforMill.ReportSource = null;

        CryDateWiseSaleRegisterforMill.Dispose();
