...
public partial class Sugar_Report_rptpurchasetcs : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (isAuthenticate == "1" || User_Type == "A")
            {
                ...
                Crypurchasetcs.ReportSource = rprt1;
    ...
    protected void Page_Unload(object sender, EventArgs e)
    {
        ...
        //rprt1.Dispose();
        //GC.Collect();
        this.Crypurchasetcs.ReportSource = null;

        Crypurchasetcs.Dispose();
