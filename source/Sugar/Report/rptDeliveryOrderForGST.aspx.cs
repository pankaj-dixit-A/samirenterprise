    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (!IsPostBack)
            {
                ...
                string Tender_DO = clsCommon.getString("select Tender_DO from qrytenderhead where Tender_No='" + tenderno + "' and Company_Code='" + Session["Company_Code"] + "' " +
            ...
            string tenderdoname = clsCommon.getString("select tenderdoname from qrytenderhead where Tender_No='" + tenderno + "' and Company_Code='" + Session["Company_Code"] + "' " +
             " and Year_Code='" + Session["year"].ToString() + "'");
