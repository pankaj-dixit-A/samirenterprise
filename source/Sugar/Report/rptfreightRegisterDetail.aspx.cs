...
using System.Data.SqlClient;
public partial class Sugar_Report_rptfreightRegisterDetail : System.Web.UI.Page
{
    int billno;
    int company_code;
    int year_code;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (isAuthenticate == "1" || User_Type == "A")
            {
                ...
                rpt.Load(Server.MapPath("CryfreightRegisterDetail.rpt"));
                rpt.SetDataSource(dt);

                CryfreightRegisterDetail.ReportSource = rpt;
                ...
                CryfreightRegisterDetail.RefreshReport();
            }
            else
            {
        ...
        using (SqlConnection con = new SqlConnection(strcon))
        {
            ...
            if (ac_code != "0")
            {
                SqlCommand cmd = new SqlCommand("select * from qrydofreightbalancedetail where  doc_date between '" + FromDt +
                   "' and '" + ToDt + "' and mill_code='" + ac_code + "' and purc_no !=0", con);
    ...
    protected void Page_Unload(object sender, EventArgs e)
    {
        ...
        //rprt1.Dispose();
        //GC.Collect();
        this.CryfreightRegisterDetail.ReportSource = null;

        CryfreightRegisterDetail.Dispose();
