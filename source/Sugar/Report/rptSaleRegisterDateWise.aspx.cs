...
public partial class Report_rptSaleRegisterDateWise : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (isAuthenticate == "1" || User_Type == "A")
            {
                ...
                pagehead = "Sale Register from " + fromdt + " To " + todt;
                ...
                rprt1.Load(Server.MapPath("CrySaleRegister.rpt"));
                rprt1.SetDataSource(dt);
                CrySaleRegister.ReportSource = rprt1;
    ...
    private DataTable GetData(string fromdt, string todt)
    {
        ...
        using (SqlConnection con = new SqlConnection(strcon))
        {
            if (Accode != "0")
            {
                SqlCommand cmd = new SqlCommand("select * from qrysalehead where doc_date between '" + datefrom + "' and '" + dateto + "' and Ac_Code='" + Accode + "' and IsDeleted!=0 and doc_no!=0", con);
            ...
            {
                SqlCommand cmd = new SqlCommand("select * from qrysalehead where doc_date between '" + datefrom + "' and '" + dateto + "' and IsDeleted!=0 and doc_no!=0", con);
                cmd.CommandType = CommandType.Text;
                SqlDataAdapter sda = new SqlDataAdapter(cmd);
                sda.Fill(dt);
            }
    ...
    protected void Page_Unload(object sender, EventArgs e)
    {
        ...
        //rprt1.Dispose();
        //GC.Collect();
        this.CrySaleRegister.ReportSource = null;

        CrySaleRegister.Dispose();
