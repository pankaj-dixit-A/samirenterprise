...
public partial class Report_rptRetailSaleRegister_Datewise : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (isAuthenticate == "1" || User_Type == "A")
            {
                ...
                pagehead = "Retail Sale Register from " + fromdt + " To " + todt;
                ...
                rprt1.Load(Server.MapPath("CryRetailSaleRegister.rpt"));
                rprt1.SetDataSource(dt);
                CryRetailSaleRegister.ReportSource = rprt1;
    ...
    private DataTable GetData(string fromdt, string todt)
    {
        ...
        using (SqlConnection con = new SqlConnection(strcon))
        {
            ...
            SqlCommand cmd = new SqlCommand("select * from qryretailsellhead where doc_date between '" + datefrom + "' and '" + dateto + "'", con);
    ...
    protected void Page_Unload(object sender, EventArgs e)
    {
        ...
        //rprt1.Dispose();
        //GC.Collect();
        this.CryRetailSaleRegister.ReportSource = null;

        CryRetailSaleRegister.Dispose();
