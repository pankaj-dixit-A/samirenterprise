...
public partial class Sugar_Report_rptSaudaBalanceSummary : System.Web.UI.Page
{
    int billno;
    int company_code;
    int year_code;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (isAuthenticate == "1" || User_Type == "A")
            {
                ...
                rpt.Load(Server.MapPath("CrySaudaBalanceSummary.rpt"));
                rpt.SetDataSource(dt);

                CrySaudaBalanceSummary.ReportSource = rpt;
                rpt.DataDefinition.FormulaFields["fromto"].Text = "\"Sauda report From " + datefrom + " To " + dateto + "\"";

                rpt.DataDefinition.FormulaFields["companyname"].Text = "\"" + company_name + "\"";

                CrySaudaBalanceSummary.RefreshReport();
    ...
    private DataTable GetData(string from, string to)
    {
        ...
        using (SqlConnection con = new SqlConnection(strcon))
        {
            ...
            if (ac_code != "0")
            {
                SqlCommand cmd = new SqlCommand("select * from qrysaudabalancesummarymain where  AMT!=0 and Sauda_Date between '" + FromDt +
    ...
    protected void btnPDF_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string pdfname = filepath + "\\SaudaBalance.pdf";
    ...
    protected void Page_Unload(object sender, EventArgs e)
    {
        ...
        //rprt1.Dispose();
        //GC.Collect();
        this.CrySaudaBalanceSummary.ReportSource = null;

        CrySaudaBalanceSummary.Dispose();
