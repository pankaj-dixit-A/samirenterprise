...
public partial class Sugar_Report_rptEquityPurchase : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (isAuthenticate == "1" || User_Type == "A")
            {
                ...
                pagehead = "Equity Purchase Register from " + fromdt + " To " + todt;
                ...
                rprt1.Load(Server.MapPath("CryEquityPurchase.rpt"));
                rprt1.SetDataSource(dt);
                CryEquityPurchase.ReportSource = rprt1;
    ...
    private DataTable GetData(string fromdt, string todt)
    {
        ...
        using (SqlConnection con = new SqlConnection(strcon))
        {
            ...
            SqlCommand cmd = new SqlCommand("select * from qryEquityPurchase where Date between '" + datefrom + "' and '" + dateto +
    ...
    protected void Page_Unload(object sender, EventArgs e)
    {
        ...
        //rprt1.Dispose();
        //GC.Collect();
        this.CryEquityPurchase.ReportSource = null;

        CryEquityPurchase.Dispose();
