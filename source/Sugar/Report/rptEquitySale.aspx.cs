...
public partial class Sugar_Report_rptEquitySale : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (isAuthenticate == "1" || User_Type == "A")
            {
                ...
                pagehead = "Equity Sale Register from " + fromdt + " To " + todt;
                ...
                rprt1.Load(Server.MapPath("CryEquitySale.rpt"));
                rprt1.SetDataSource(dt);
                CryEquitySale.ReportSource = rprt1;
    ...
    private DataTable GetData(string fromdt, string todt)
    {
        ...
        using (SqlConnection con = new SqlConnection(strcon))
        {
            ...
            SqlCommand cmd = new SqlCommand("select * from qryEquitysale where Date between '" + datefrom + "' and '" + dateto + "' and Company_Code=" + Convert.ToInt32(Session["Company_Code"].ToString()) + "and Year_Code=" + Convert.ToInt32(Session["year"].ToString()), con);
    ...
    protected void Page_Unload(object sender, EventArgs e)
    {
        ...
        //rprt1.Dispose();
        //GC.Collect();
        this.CryEquitySale.ReportSource = null;

        CryEquitySale.Dispose();
