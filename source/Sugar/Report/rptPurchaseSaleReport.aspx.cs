...
public partial class Sugar_Report_rptPurchaseSaleReport : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (isAuthenticate == "1" || User_Type == "A")
            {
                ...
                pagehead = "Purchase Sale Report from " + fromdt + " To " + todt;
                ...
                rprt1.Load(Server.MapPath("CryPurchaseSaleReport.rpt"));
                rprt1.SetDataSource(dt);
                CryPurchaseSaleReport.ReportSource = rprt1;
    ...
    private DataTable GetData(string fromdt, string todt)
    {
        ...
        using (SqlConnection con = new SqlConnection(strcon))
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("select * from Future_Head where doc_date between '" + datefrom + "' and '" + dateto + "' and Company_Code=" + Convert.ToInt32(Session["Company_Code"].ToString()) + " and Year_Code=" + Convert.ToInt32(Session["year"].ToString()), con);
            ...
            {
                SqlCommand cmd = new SqlCommand("select * from Future_Head where doc_date between '" + datefrom + "' and '" + dateto + "'  and AC_Code='" + Accode +
                    "' and Company_Code=" + Convert.ToInt32(Session["Company_Code"].ToString()) + " and Year_Code=" + Convert.ToInt32(Session["year"].ToString()), con);
                cmd.CommandType = CommandType.Text;
                SqlDataAdapter sda = new SqlDataAdapter(cmd);
                sda.Fill(dt);
            }
    ...
    protected void btnPDF_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string filename = filepath + "\\PurchaseSaleReport" + company_code + "_" + year_code + "_" + DateTime.Now.ToString("ddMMyyyy_HHmmss") + ".pdf";
    ...
    protected void btnMail_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (txtEmail.Text != string.Empty)
            {
                ...
                contentType.Name = "PurchaseSaleReport";
    ...
    protected void Page_Unload(object sender, EventArgs e)
    {
        ...
        //rprt1.Dispose();
        //GC.Collect();
        this.CryPurchaseSaleReport.ReportSource = null;

        CryPurchaseSaleReport.Dispose();
