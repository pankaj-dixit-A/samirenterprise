...
public partial class Sugar_Report_rptpurchasetcs1 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (isAuthenticate == "1" || User_Type == "A")
            {
                ...
                pagehead = "TCS Purchase Register from " + fromdt + " To " + todt;
                ...
                rprt1.Load(Server.MapPath("Crypurchasetcs.rpt"));
                rprt1.SetDataSource(dt);
                Crypurchasetcs1.ReportSource = rprt1;
    ...
    private DataTable GetData(string fromdt, string todt, string accode)
    {
        ...
        using (SqlConnection con = new SqlConnection(strcon))
        {
            ...
            if (Accode == "0")
            {
                cmd = new SqlCommand("select * from qryTCSPurchaseUnion where date between '" + datefrom + "' and '" + dateto + "' and TCS !=0 ", con);
            }
            else
            {
                cmd = new SqlCommand("select * from qryTCSPurchaseUnion where date  between '" + datefrom + "' and '" + dateto + "' and Party_Code= '" + Accode + "'and TCS !=0", con);
            }
    ...
    protected void btnPDF_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string filename = filepath + "\\PurchaseTCS" + company_code + "_" + year_code + "_" + DateTime.Now.ToString("ddMMyyyy_HHmmss") + ".pdf";
    ...
    protected void Page_Unload(object sender, EventArgs e)
    {
        ...
        //rprt1.Dispose();
        //GC.Collect();
        this.Crypurchasetcs1.ReportSource = null;

        Crypurchasetcs1.Dispose();
