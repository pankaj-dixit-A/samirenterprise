    ...
    <form id="form1" runat="server">
        <div id="printReady">
            ...
            <asp:TextBox runat="server" ID="txtEmail" Width="300px"></asp:TextBox>
             <asp:Button ID="btnmilltransport" runat="server" Text="Mail PDF" Width="80px" OnClientClick="return CheckEmail();"
                OnClick="btnmilltransport_Click" />
            <asp:TextBox runat="server" ID="txtTransportmail" Width="300px"></asp:TextBox>
             <asp:Button ID="btnpurchmail" runat="server" Text="Mail PDF" Width="80px" OnClientClick="return CheckEmail();"
