            ...
            <asp:Panel ID="pnlMain" runat="server" Font-Names="verdana" Font-Bold="true" ForeColor="Black"
                ...
                <table style="width: 100%;" align="Left" cellpadding="4" cellspacing="4">
                    ...
                    <tr>
                        <td align="left" style="width: 10%;">
                            ...
                            <asp:Button Width="20px" Height="24px" ID="btntxtDoc_No" runat="server" TabIndex="3" Text="..."
                           ...
                           --%>
                            ...
                            Broker Code
                            <asp:TextBox Height="24px" ID="txtBroker_code" runat="Server" CssClass="txt" TabIndex="5"
                            ...
                            <asp:Button Width="20px" Height="24px" ID="btntxtBroker_code" runat="server" TabIndex="6" Text="..."
                    ...
                    <tr>
                        <td align="left" style="width: 10%;">
                            Bill No
                            <asp:TextBox Height="24px" ID="txtBill_No" runat="Server" CssClass="txt" TabIndex="7"
                                Width="150px" Style="text-align: left;" AutoPostBack="false" OnTextChanged="txtBill_No_TextChanged"></asp:TextBox>
                            Sattlement No
                            <asp:TextBox Height="24px" ID="txtsattlement_No" runat="Server" CssClass="txt" TabIndex="8"
                                Width="150px" Style="text-align: left;" AutoPostBack="false" OnTextChanged="txtsattlement_No_TextChanged"></asp:TextBox>
                            Remark
                            <asp:TextBox Height="40px" ID="txtRemark" runat="Server" CssClass="txt" TabIndex="9"
                    ...
                    <tr>
                        <td colspan="4" align="left">
                            <asp:Button ID="btnOpenDetailsPopup" runat="server" Text="ADD" CssClass="btnHelp"
                                Width="80px" Height="25px" OnClick="btnOpenDetailsPopup_Click" TabIndex="39"
                                Visible="false" />
                        </td>
                    </tr>
                </table>
                ...
                <table width="80%" align="left">
                    ...
                    <tr>
                        <td align="left" style="width: 10%;">
                            Script Code
                            <asp:TextBox ID="txtScript_Code" runat="Server" CssClass="txt" TabIndex="10" Width="90px"
                                Style="text-align: left;" AutoPostBack="false" OnTextChanged="txtScript_Code_TextChanged"
                                Height="24px"></asp:TextBox>
                            <asp:Button ID="btntxtScript_Code" runat="server" Text="..." TabIndex="11" OnClick="btntxtScript_Code_Click"
                                CssClass="btnHelp" />
                            <asp:Label ID="lblscrpit_Code" runat="server" CssClass="lblName"></asp:Label>
                            Expiry Date
                            <asp:TextBox ID="txtExpiry_date" runat="Server" CssClass="txt" TabIndex="12" Width="90px"
                            ...
                            <asp:Button ID="btnexpriydate" runat="server" Text="..." OnClick="btnexpriydate_Click" TabIndex="13"
                                CssClass="btnHelp" />
                            ...
                            Lot Size
                            <asp:TextBox ID="txtLot_Size" runat="Server" CssClass="txt" TabIndex="14" Width="90px"
                            ...
                            <asp:DropDownList ID="drpFuture_Type" runat="server" AutoPostBack="true" CssClass="ddl"
                                Height="25px" OnSelectedIndexChanged="drpFuture_Type_SelectedIndexChanged" TabIndex="15"
                                Width="200px">
                            ...
                            <asp:DropDownList ID="drpBuy_Sale" runat="server" AutoPostBack="true" CssClass="ddl"
                                Height="25px" OnSelectedIndexChanged="drpBuy_Sale_SelectedIndexChanged" TabIndex="16"
                                Width="200px">
                    ...
                    <tr>
                        <td align="left" style="width: 10%;">
                            Lot Qty
                            <asp:TextBox ID="txtlot_qty" runat="Server" CssClass="txt" TabIndex="17" Width="90px"
                                Style="text-align: left;" AutoPostBack="true" OnTextChanged="txtlot_qty_TextChanged"
                                Height="24px"></asp:TextBox>
                            Rate
                            <asp:TextBox ID="txtRate" runat="Server" CssClass="txt" TabIndex="18" Width="90px"
                                Style="text-align: left;" AutoPostBack="true" OnTextChanged="txtRate_TextChanged"
                                Height="24px"></asp:TextBox>
                            value
                            <asp:TextBox ID="txtValue" runat="Server" CssClass="txt" TabIndex="19" Width="90px"
                                Style="text-align: left;" AutoPostBack="false" OnTextChanged="txtValue_TextChanged"
                                Height="24px"></asp:TextBox>
                            Strike Price
                            <asp:TextBox ID="txtStrike_Price" runat="Server" CssClass="txt" TabIndex="20" Width="90px"
                            ...
                            <asp:Button ID="btnAdddetails" runat="server" Text="ADD" CssClass="btnHelp" Width="80px"
                                Height="25px" OnClick="btnAdddetails_Click" TabIndex="21" />
                            <asp:Button ID="btnClosedetails" runat="server" Text="Close" CssClass="btnHelp"
                                Width="80px" Height="25px" OnClick="btnClosedetails_Click" TabIndex="22" />
                            <asp:Button ID="btnDaily_Positoin" runat="server" Text="Daily Positoin" CssClass="btnHelp"
                                Width="90px" ValidationGroup="save" OnClick="btnDaily_Positoin_Click" TabIndex="23" Height="24px" />
                            <asp:Button ID="btnDeletebtnDaily_Positoin" runat="server" Text="Delete Daily Positoin"
                                CssClass="btnHelp" Width="120px" ValidationGroup="save" OnClick="DeletebtnDaily_Positoin_Click" TabIndex="24"
                    ...
                    <ContentTemplate>
                        <table cellpadding="4" cellspacing="4" align="left">
                            ...
                            <tr style="font-family: Verdana; color: Black;">
                                <td align="left" style="width: 10%;">
                                    <b>Net Brokrage</b>
                                    <asp:TextBox Height="24px" ID="txtNetbrokrage" runat="Server" CssClass="txt" TabIndex="25"
                                    ...
                                    <asp:TextBox Height="24px" ID="txtnetExchangecharges" runat="Server" CssClass="txt"
                                        TabIndex="26" Width="90px" Style="text-align: left;" AutoPostBack="true" OnTextChanged="txtnetExchangecharges_TextChanged"></asp:TextBox>
                                    <b>Net STF</b>
                                    <asp:TextBox Height="24px" ID="txtnetSTF" runat="Server" CssClass="txt" TabIndex="27"
                                        Width="90px" Style="text-align: left;" AutoPostBack="true" OnTextChanged="txtnetSTF_TextChanged"></asp:TextBox>
                                    <b>Net STT</b>
                                    <asp:TextBox Height="24px" ID="txtNet_Stt" runat="Server" CssClass="txt" TabIndex="28"
                                        Width="90px" Style="text-align: left;" AutoPostBack="true" OnTextChanged="txtNet_Stt_TextChanged"></asp:TextBox>
                                    <b>Net StampDuty</b>
                                    <asp:TextBox Height="24px" ID="txtNet_StampDuty" runat="Server" CssClass="txt" TabIndex="29"
                                        Width="90px" Style="text-align: left;" AutoPostBack="true" OnTextChanged="txtNet_StampDuty_TextChanged"></asp:TextBox>
                                    <b>Net CM Charge</b>
                                    <asp:TextBox Height="24px" ID="txtcmcharge" runat="Server" CssClass="txt" TabIndex="30"
