...
public partial class Sugar_Report_rptTaxRegister : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (isAuthenticate == "1" || User_Type == "A")
            {
                ...
                pagehead = "Tax Register from " + fromdt + " To " + todt;
                ...
                rprt1.Load(Server.MapPath("CryTaxRegister.rpt"));
                rprt1.SetDataSource(dt);
                CryTaxRegister.ReportSource = rprt1;
    ...
    private DataTable GetData(string fromdt, string todt)
    {
        ...
        using (SqlConnection con = new SqlConnection(strcon))
        {
            ...
            SqlCommand cmd = new SqlCommand("select * from qryEquityPurchaseSale where Date between '" + datefrom + "' and '" + dateto + 
    ...
    protected void Page_Unload(object sender, EventArgs e)
    {
        ...
        //rprt1.Dispose();
        //GC.Collect();
        this.CryTaxRegister.ReportSource = null;

        CryTaxRegister.Dispose();
