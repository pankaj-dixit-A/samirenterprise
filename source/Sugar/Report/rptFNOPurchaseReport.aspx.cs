...
using System.Data.SqlClient;
public partial class Sugar_Report_rptFNOPurchaseReport : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (isAuthenticate == "1" || User_Type == "A")
            {
                ...
                Buy_Sale = Request.QueryString["Buy_Sale"];
                if (Buy_Sale == "B")
                {
                    pagehead = "FNO Purchase Register from " + fromdt + " To " + todt;
                }
                else
                {
                    pagehead = "FNO Sale Register from " + fromdt + " To " + todt;
                ...
                rprt1.Load(Server.MapPath("CryFNOPurchaseReport.rpt"));
                rprt1.SetDataSource(dt);
                CryFNOPurchaseReport.ReportSource = rprt1;
    ...
    private DataTable GetData(string fromdt, string todt)
    {
        ...
        using (SqlConnection con = new SqlConnection(strcon))
        {
            if (Buy_Sale == "B")
            {
                ...
                {
                    SqlCommand cmd = new SqlCommand("select * from QryFutureTranstion where doc_date between '" + datefrom + "' and '" + dateto +
                        "' and Buy_Sale='B' and Company_Code=" + Convert.ToInt32(Session["Company_Code"].ToString()) + " and Year_Code=" + Convert.ToInt32(Session["year"].ToString()), con);
                ...
                {
                    SqlCommand cmd = new SqlCommand("select * from QryFutureTranstion where doc_date between '" + datefrom + "' and '" + dateto + "' and Buy_Sale='B' and AC_Code='" 
                        + Accode + "' and Company_Code=" + Convert.ToInt32(Session["Company_Code"].ToString())+" and Year_Code=" + Convert.ToInt32(Session["year"].ToString()), con);
                    cmd.CommandType = CommandType.Text;
                    SqlDataAdapter sda = new SqlDataAdapter(cmd);
                    sda.Fill(dt);
                }
            ...
            else
            {
                ...
                {
                    SqlCommand cmd = new SqlCommand("select * from QryFutureTranstion where doc_date between '" + datefrom + "' and '" + dateto +
                        "' and Buy_Sale='S' and Company_Code=" + Convert.ToInt32(Session["Company_Code"].ToString()) + " and Year_Code=" + Convert.ToInt32(Session["year"].ToString()), con);
                    cmd.CommandType = CommandType.Text;
                    SqlDataAdapter sda = new SqlDataAdapter(cmd);
                    sda.Fill(dt);
                }
                ...
                {
                    SqlCommand cmd = new SqlCommand("select * from QryFutureTranstion where doc_date between '" + datefrom + "' and '" + dateto +
                        "' and Buy_Sale='S' and AC_Code='" + Accode + "' and Company_Code=" + Convert.ToInt32(Session["Company_Code"].ToString()) + " and Year_Code=" + Convert.ToInt32(Session["year"].ToString()), con);
                    cmd.CommandType = CommandType.Text;
                    SqlDataAdapter sda = new SqlDataAdapter(cmd);
                    sda.Fill(dt);
                }
    ...
    protected void btnPDF_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string filename = filepath + "\\FNOPurchaseOrder" + company_code + "_" + year_code + "_" + DateTime.Now.ToString("ddMMyyyy_HHmmss") + ".pdf";
    ...
    protected void btnMail_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string filename = filepath + "\\FNOPurchaseOrder_" + company_code + "_" + year_code + "_" + DateTime.Now.ToString("ddMMyyyy_HHmmss") + ".pdf";
            rprt1.ExportToDisk(CrystalDecisions.Shared.ExportFormatType.PortableDocFormat, filename);
            ...
            if (txtEmail.Text != string.Empty)
            {
                ...
                contentType.Name = "FNOPurchaseOrder";
    ...
    protected void Page_Unload(object sender, EventArgs e)
    {
        ...
        //rprt1.Dispose();
        //GC.Collect();
        this.CryFNOPurchaseReport.ReportSource = null;

        CryFNOPurchaseReport.Dispose();
