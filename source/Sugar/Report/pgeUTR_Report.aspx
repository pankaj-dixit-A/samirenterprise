...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <center>
        ...
        <table>
            ...
            <tr>
                <td align="left" style="width: 40%;">
                    <asp:Button ID="btnmillcashdiff" runat="server" Text="Mill Cash Diff" CssClass="btnHelp"
                        Width="170px" Height="24px" TabIndex="6" OnClick="btnmillcashdiff_Click" />
                </td>
                <td align="right" style="width: 50%;">
                    <asp:Button ID="btnpartybrokercashdiff" runat="server" Text="Party Broker Cash Diff"
            ...
            <tr>
                ...
                <td align="right" style="width: 50%;">
                    <asp:Button ID="btnDoCashDiff" runat="server" Text="Do Cash Diff" CssClass="btnHelp"
            ...
            <tr>
                ...
                <td>
                    <asp:Button ID="btntenderidwisesauda" runat="server" Text="TenderId Wise Sauda" CssClass="btnHelp"
                        Width="170px" Height="24px" TabIndex="6" OnClick="btntenderidwisesauda_Click" OnClientClick="Confirm12()" />
                </td>
                <td align="right" style="width: 50%;">
            ...
            <tr>
                <td align="left" style="width: 40%;">
                    <asp:Button ID="btnDoCancle" runat="server" Text="Do Cancle" CssClass="btnHelp"
                        Width="170px" Height="24px" TabIndex="6" OnClick="btnDoCancle_Click" />
                </td>
