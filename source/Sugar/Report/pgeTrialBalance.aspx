        ...
        <table width="60%" align="center" cellpadding="10" cellspacing="5">
            ...
            <tr>
                <td colspan="2" align="left">
                    ...
                    <asp:Button ID="btnCashdiffTrailBalance" runat="server" Text="Cash Diff Trail Balance" CssClass="btnHelp"
                        Width="150px" OnClick="btnCashdiffTrailBalance_Click" Height="24px" />
