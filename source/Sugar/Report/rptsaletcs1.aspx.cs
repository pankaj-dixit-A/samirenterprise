...
public partial class Sugar_Report_rptsaletcs1 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (isAuthenticate == "1" || User_Type == "A")
            {
                ...
                pagehead = "TCS Sale Register from " + fromdt + " To " + todt;
                ...
                rprt1.Load(Server.MapPath("Crysaletcs.rpt"));
                rprt1.SetDataSource(dt);
                Crysaletcs1.ReportSource = rprt1;
    ...
    private DataTable GetData(string fromdt, string todt, string accode)
    {
        ...
        using (SqlConnection con = new SqlConnection(strcon))
        {
            ...
            if (Accode == "0")
            {
                cmd = new SqlCommand("select * from qryTCSSaleUnion where Inv_date between '" + datefrom + "' and '" + dateto + "' and TCS !=0 and IsDeleted!=0 ", con);
            }
            else
            {
                cmd = new SqlCommand("select * from qryTCSSaleUnion where Inv_date  between '" + datefrom + "' and '" + dateto + "' and Party_Code= '" + Accode + "'and TCS !=0 and IsDeleted!=0 ", con);
            }
    ...
    protected void Page_Unload(object sender, EventArgs e)
    {
        ...
        //rprt1.Dispose();
        //GC.Collect();
        this.Crysaletcs1.ReportSource = null;
