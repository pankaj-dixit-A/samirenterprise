<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptPurchaseSaleReport.aspx.cs" Inherits="Sugar_Report_rptPurchaseSaleReport" %>
...
<body>
    ...
    <div>
        ...
        <CR:CrystalReportViewer ID="CryPurchaseSaleReport" runat="server" AutoDataBind="true"
