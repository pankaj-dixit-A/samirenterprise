...
public partial class Sugar_Report_rptperidoctribalnce : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (isAuthenticate == "1" || User_Type == "A")
            {
                ...
                pagehead = "Peridoc Trail Balance Register from " + fromdt + " To " + todt;
                ...
                rprt1.Load(Server.MapPath("Cryperidoctribalnce.rpt"));
                rprt1.SetDataSource(dt);
                Cryperidoctribalnce.ReportSource = rprt1;
    ...
    private DataTable GetData(string fromdt, string todt)
    {
        ...
        using (SqlConnection con = new SqlConnection(strcon))
        {
            ...
            cmd = new SqlCommand("select ac_code,ac_name_e,group_code,group_name_e, case when DRCR='D' then  AMOUNT else 0 end as debit,case when DRCR='C' then AMOUNT else 0 end as credit from qrygledger " +
                    "where DOC_DATE between '" + datefrom + "' and '" + dateto + "'", con);
    ...
    protected void Page_Unload(object sender, EventArgs e)
    {
        ...
        //rprt1.Dispose();
        //GC.Collect();
        this.Cryperidoctribalnce.ReportSource = null;

        Cryperidoctribalnce.Dispose();
