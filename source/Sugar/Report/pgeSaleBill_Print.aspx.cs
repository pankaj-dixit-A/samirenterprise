...
public partial class Sugar_Report_pgeSaleBill_Print : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            string salepartynew = clsCommon.getString("select Buyer from nt_1_tenderdetails where tenderdetailid=" + tenderdetailid + " and Company_Code=" + Convert.ToInt32(Session["Company_Code"].ToString()) + " and Year_Code=" + Convert.ToInt32(Session["year"].ToString()));
    ...
    private DataTable GetData()
    {
        try
        {
            ...
            season = clsCommon.getString("select season from nt_1_tender where Tender_No=" + purno + " and Company_Code=" + Convert.ToInt32(Session["Company_Code"].ToString()) + " and Year_Code=" + Convert.ToInt32(Session["year"].ToString()));
