...
public partial class Sugar_Report_rptEquityGlobal : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (isAuthenticate == "1" || User_Type == "A")
            {
                ...
                pagehead = "Equity Global Register from " + fromdt + " To " + todt;
                ...
                rprt1.Load(Server.MapPath("CryEquityGlobal.rpt"));
                rprt1.SetDataSource(dt);
                CryEquityGlobal.ReportSource = rprt1;
    ...
    private DataTable GetData(string fromdt, string todt)
    {
        ...
        using (SqlConnection con = new SqlConnection(strcon))
        {
            ...
            SqlCommand cmd = new SqlCommand("select * from qryEquityGlobal where Company_Code=" + Convert.ToInt32(Session["Company_Code"].ToString()) +
    ...
    protected void Page_Unload(object sender, EventArgs e)
    {
        ...
        //rprt1.Dispose();
        //GC.Collect();
        this.CryEquityGlobal.ReportSource = null;

        CryEquityGlobal.Dispose();
