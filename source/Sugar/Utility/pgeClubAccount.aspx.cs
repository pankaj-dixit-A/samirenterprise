            ...
            try
            {
                ...
                for (int i = 0; i < stringArr.Length; i++)
                {
                    ...
                    ExecuteSP("carporatehead", stringArr[i], Convert.ToInt32(Wrong_AcCode), Convert.ToInt32(Ac_CodeToReplace), "Company_Code=" +
                        Convert.ToInt32(Session["Company_Code"].ToString()), stringautid[i], accoid);
                }
                ...
                for (int j = 0; j < stringArr.Length; j++)
                {
                   ExecuteSP(tblPrefix + "deliveryorder", stringArr[j], Convert.ToInt32(Wrong_AcCode), Convert.ToInt32(Ac_CodeToReplace), "company_code=" 
                       + Convert.ToInt32(Session["Company_Code"].ToString()) + " and Year_Code=" + Convert.ToInt32(Session["year"].ToString()) , stringautid[j], accoid);
                }

                //DO details
                ExecuteSP(tblPrefix + "dodetails", "Bank_Code", Convert.ToInt32(Wrong_AcCode), Convert.ToInt32(Ac_CodeToReplace), "Company_Code=" 
                    + Convert.ToInt32(Session["Company_Code"].ToString()) + " and Year_Code=" + Convert.ToInt32(Session["year"].ToString()), "bc", accoid);
                ...
                {
                    ExecuteSP(tblPrefix + "gledger", stringArr[k], Convert.ToInt32(accoid), Convert.ToInt32(Ac_CodeToReplace), "Company_Code=" +
                        Convert.ToInt32(Session["Company_Code"].ToString()), stringautid[k], accoid);
                ...
                for (int k = 0; k < stringArr.Length; k++)
                {
                    ...
                    ExecuteSP(tblPrefix + "sugarpurchase", stringArr[k], Convert.ToInt32(Wrong_AcCode), Convert.ToInt32(Ac_CodeToReplace), "Company_Code="
                      + Convert.ToInt32(Session["Company_Code"].ToString()) + " and Year_Code=" + Convert.ToInt32(Session["year"].ToString()), stringautid[k], accoid);
                }
