            ...
            if (ds != null)
            {
                if (ds.Tables.Count > 0)
                {
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        string doc_no = "RR" + dt.Rows[0]["Doc_No"].ToString();
                        txtDoc_No.Text = doc_no;
                        txtDoc_Date.Text = dt.Rows[0]["doc_date"].ToString();
                        drpDoc_Type.SelectedValue = "INV";
                        txtSellerGST_No.Text = gstno;
    ...
    private void BindServiceEwayBill()
    {
        try
        {
            ...
            qryelement = "select doc_no as Doc_No,CONVERT(varchar,doc_date,103) as doc_date,UPPER(BuyerGst_No) as BuyerGst_No," +
                       ...
                       " from NT_1qryEInvoiceServiceBill  where  Company_Code=" + Convert.ToInt32(Session["Company_Code"].ToString()) + " and doc_no=" + Dono + " and Year_Code=" + Convert.ToInt32(Session["year"].ToString());
            ...
            else
            {
                ...
                if (index > 0)
                {
                    ...
                    qry1 = "update NT_1_SugarSale set ackno=" + AckNo + ",einvoiceno='" + Irn + "' where company_code=" + Convert.ToInt32(Session["Company_Code"].ToString())
                       + " and Year_Code=" + Convert.ToInt32(Session["year"].ToString()) + " and newsbno=" + sbnoNew;
                    ds = clsDAL.SimpleQuery(qry1);
        ...
        if (b)
        {
            ...
            else
            {
                ...
                if (index > 0)
                {
                    ...
                    if (type == "SB")
                    {
                        if (ID == string.Empty)
                        {
                            ...
                            qry1 = "update NT_1_SugarSale set ackno=" + AckNo + ",einvoiceno='" + Irn + "',QRCode='" + QRCode + "' where company_code=" + Convert.ToInt32(Session["Company_Code"].ToString())
                               + " and Year_Code=" + Convert.ToInt32(Session["year"].ToString()) + " and doc_no=" + sbnoNew;
                            ds = clsDAL.SimpleQuery(qry1);
                            ScriptManager.RegisterClientScriptBlock(this, this.GetType(), " ", "alert('EInvoice Generated Successfully !');", true);
                        }
                        else
                    ...
                    {
                        qry1 = "update Retail_Head set ACK='" + AckNo + "',Envoiceno='" + Irn + "' where  company_code=" + Convert.ToInt32(Session["Company_Code"].ToString())
                    ...
                    {
                        qry1 = "update nt_1_sugarsalereturn set ackno='" + AckNo + "',einvoiceno='" + Irn + "' where  company_code=" + Convert.ToInt32(Session["Company_Code"].ToString())
                         + " and Year_Code=" + Convert.ToInt32(Session["year"].ToString()) + " and doc_no=" + Dono;
                        ds = clsDAL.SimpleQuery(qry1);
                        ScriptManager.RegisterClientScriptBlock(this, this.GetType(), " ", "alert('EInvoice Generated Successfully !');", true);
                    ...
                    else if (type == "LV")
                    {
                        if (DoIDNo == string.Empty || DoIDNo == "0")
                        {
                            ...
                            qry1 = "update commission_bill set ackno='" + AckNo + "',einvoiceno='" + Irn + "' where  company_code=" + Convert.ToInt32(Session["Company_Code"].ToString())
                    ...
                    {
                        qry1 = "update nt_1_sugarpurchasereturn set ackno='" + AckNo + "',einvoiceno='" + Irn + "' where  company_code=" + Convert.ToInt32(Session["Company_Code"].ToString())
                            + " and Year_Code=" + Convert.ToInt32(Session["year"].ToString()) + " and doc_no=" + Dono;
                        ds = clsDAL.SimpleQuery(qry1);
                        ScriptManager.RegisterClientScriptBlock(this, this.GetType(), " ", "alert('EInvoice Generated Successfully !');", true);
                    }
