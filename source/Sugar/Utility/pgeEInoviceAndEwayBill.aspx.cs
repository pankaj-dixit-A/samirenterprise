        ...
        if (b)
        {
            ...
            else
            {
                ...
                if (index > 0)
                {
                    ...
                    {
                        qry1 = "update Retail_Head set ACK='" + AckNo + "',Envoiceno='" + Irn + "',EwayBillNo='" + EwbNo + "' where  company_code=" + Convert.ToInt32(Session["Company_Code"].ToString())
                    ...
                    {
                        qry1 = "update nt_1_sugarsalereturn set ackno='" + AckNo + "',einvoiceno='" + Irn + "',Eway_Bill_No='" + EwbNo + "' where  company_code=" + Convert.ToInt32(Session["Company_Code"].ToString())
                         + " and Year_Code=" + Convert.ToInt32(Session["year"].ToString()) + " and doc_no=" + Dono;
                        ds = clsDAL.SimpleQuery(qry1);
                        ScriptManager.RegisterClientScriptBlock(this, this.GetType(), " ", "alert('EInvoice & EwayBill Generated Successfully !');", true);
