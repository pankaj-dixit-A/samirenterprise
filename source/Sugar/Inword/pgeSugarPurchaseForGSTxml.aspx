    ...
    <script type="text/javascript">
        ...
        function pagevalidation() {
            ...
            var XML = XML + "<PurchaseHead " + DOCNO + " PURCNO='" + PURCNO + "' doc_date='" + doc_date + "' Ac_Code ='" + Ac_Code + "' Unit_Code='" + Unit_Code + "' " +
               ...
               "Purcid='" + Purcid + "' SelfBal='" + SelfBal + "' TCS_Rate='" + TCS_Rate + "' TCS_Amt='" + TCS_Amt + "' TCS_Net_Payable='" + TCS_Net_Payable + "' TDS_Rate='" + TDS_Rate + "' TDS_Amt='" + TDS_Amt + "'>";
            //Detail Calculation
                                ...
                                <tr>
                                    ...
                                    <td style="">
                                        <asp:TextBox ID="txtTDS" runat="Server" CssClass="txt" Width="42px" AutoPostBack="true"
                                            OnTextChanged="txtTDS_TextChanged" TabIndex="31" Style="text-align: right;"
                                            Height="24px"></asp:TextBox>
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <asp:TextBox ID="txtTCSNet_Payable" runat="Server" CssClass="txt" ReadOnly="true"
                                            TabIndex="32" Width="120px" Style="text-align: right;" AutoPostBack="True" OnTextChanged="txtTCSNet_Payable_TextChanged"
                                            Height="24px"></asp:TextBox>
