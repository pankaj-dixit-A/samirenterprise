                ...
                <table style="width: 60%;" align="center" cellpadding="4" cellspacing="4">
                    <tr>
                        ...
                        <tr>
                         ...
                         <tr>
                            <td align="right" style="width: 10%;">ISIN No
                            </td>
                            <td align="left" style="width: 10%;">
                                <asp:TextBox Height="24px" ID="txtisin_no" runat="Server" CssClass="txt" TabIndex="7"
                                    Width="90px" Style="text-align: left;" AutoPostBack="false" onKeyDown="Focusbtn(event);"
                                    OnTextChanged="txtisin_no_TextChanged"></asp:TextBox>
                                <%--<ajax1:FilteredTextBoxExtender ID="filtertxtisin_no" runat="server" FilterType="Numbers,Custom"
                                    ValidChars="." TargetControlID="txttxtisin_no">
                                </ajax1:FilteredTextBoxExtender>--%>
                            </td>
                        </tr>
                </table>
