...
function SelectRow(CurrentRow, RowIndex) {
    ...
    <script type="text/javascript">
        ...
        function EquitySale(e) {
            ...
            if (e.keyCode == 9) {
                e.preventDefault();
                var unit = $("#<%=txtEquitySale_ac.ClientID %>").val();

                unit = "0" + unit;
                $("#<%=txtEquitySale_ac.ClientID %>").val(unit);
        ...
        function EquityPurchase(e) {
            ...
            if (e.keyCode == 9) {
                e.preventDefault();
                var unit = $("#<%=txtEquityPurchase_ac.ClientID %>").val();

                unit = "0" + unit;
                $("#<%=txtEquityPurchase_ac.ClientID %>").val(unit);
                        ...
                        <tr>
                            ...
                            <td align="left" style="width: 10%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <asp:TextBox ID="txtEquitySale_ac" runat="Server" CssClass="txt" TabIndex="1" Width="80px"
                                    Height="24px" Style="text-align: right;" OnkeyDown="EquitySale(event);" AutoPostBack="false" OnTextChanged="txtEquitySale_ac_TextChanged"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td align="left" style="width: 10%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <asp:TextBox ID="txtEquityPurchase_ac" runat="Server" CssClass="txt" TabIndex="2" Width="80px"
                                    Height="24px" Style="text-align: right;" OnkeyDown="EquityPurchase(event);" AutoPostBack="false" OnTextChanged="txtEquityPurchase_ac_TextChanged"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td align="left" style="width: 10%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <asp:TextBox ID="txtEquityExpenses_ac" runat="Server" CssClass="txt" TabIndex="3" Width="80px"
                                    Height="24px" Style="text-align: right;" OnkeyDown="EquityExpenses(event);" AutoPostBack="false" OnTextChanged="txtEquityExpenses_ac_TextChanged"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td align="left" style="width: 10%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <asp:TextBox ID="txtFNOSale_ac" runat="Server" CssClass="txt" TabIndex="4" Width="80px"
                                    Height="24px" Style="text-align: right;" OnkeyDown="FNOSale(event);" AutoPostBack="false" OnTextChanged="txtFNOSale_ac_TextChanged"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td align="left" style="width: 10%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <asp:TextBox ID="txtFNOPurchase_ac" runat="Server" CssClass="txt" TabIndex="5" Width="80px"
                                    Height="24px" Style="text-align: right;" OnkeyDown="FNOPurchase(event);" AutoPostBack="false" OnTextChanged="txtFNOPurchase_ac_TextChanged"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td align="left" style="width: 10%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                             <asp:TextBox ID="txtFNOExpenses_ac" runat="Server" CssClass="txt" TabIndex="6" Width="80px"
                                 Height="24px" Style="text-align: right;" OnkeyDown="FNOExpenses(event);" AutoPostBack="false" OnTextChanged="txtFNOExpenses_ac_TextChanged"></asp:TextBox>
