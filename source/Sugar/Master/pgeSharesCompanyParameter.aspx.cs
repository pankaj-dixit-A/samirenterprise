...
public partial class Sugar_Master_pgeSharesCompanyParameter : System.Web.UI.Page
{
    ...
    protected void btnUpdate_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            string checkyear = clsCommon.getString("select Year_Code from SharesCompanyParameter where Year_Code=" + Convert.ToInt32(Session["year"]).ToString()+" and Company_code="+Convert.ToInt32(Session["Company_code"]).ToString());
    ...
    private void csCalculations()
    {
        try
        {
            ...
            if (strTextBox == "txtEquitySale_ac")
            {
                ...
                {
                    string str = clsCommon.getString("select Ac_Name_E from " + qryCommon + " where Ac_Code=" + txtEquitySale_ac.Text + " and Company_Code=" + Convert.ToInt32(Session["Company_Code"].ToString()));
