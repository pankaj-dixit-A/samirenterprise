<%@ Page Language="C#" Title="U-Tender Purchase" AutoEventWireup="true" MasterPageFile="~/MasterPage.master" CodeFile="PgeTenderHeadUtility.aspx.cs" Inherits="Sugar_Master_PgeTenderHeadUtility" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function GetCustomers(pageIndex) {
            ...
            $.ajax({
                type: "POST",
                url: "../BussinessRelated/PgeTenderHeadUtility.aspx/GetCustomers",
        ...
        function OnSuccess(response) {
            ...
            if (customers.length > 0) {
                $.each(customers, function () {
                    ...
                    $("td", row).eq(1).html($(this).find("Tender_Date").text());
                    $("td", row).eq(2).html($(this).find("millshortname").text());
                    $("td", row).eq(3).html($(this).find("Quantal").text());
                    $("td", row).eq(4).html($(this).find("Grade").text());
                    $("td", row).eq(5).html($(this).find("Mill_Rate").text());
                    $("td", row).eq(6).html($(this).find("tenderdoname").text());
                    $("td", row).eq(7).html($(this).find("season").text());
                    $("td", row).eq(8).html($(this).find("brokername").text());
                    $("td", row).eq(9).html($(this).find("Lifting_Date").text());
                    $("td", row).eq(10).html($(this).find("tenderid").text());
            ...
            $('#gvCustomers ').on('dblclick', 'tr', function () {
                ...
                if (row_index > 0) {
                    if (isNaN(Ac_Code)) {
                        ...
                        window.open('../BussinessRelated/pgeTenderPurchasexml.aspx?tenderid=' + Ac_Code + '&Action=' + Action);
                    }
                }
    ...
    <script type="text/javascript">
        function TenderHead() {
            ...
            window.open('../BussinessRelated/pgeTenderPurchasexml.aspx?Tender_No=' + Ac_Code + '&Action=' + Action);
        }
    </script>
    <script type="text/javascript">
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:UpdatePanel ID="UpdatePanelMain" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;    
             <asp:Label ID="lblUtilityName" runat="server" Text="Tender Purchase" Font-Bold="True"
            ...
            <div id="popup" style="max-height: 600px; overflow-y: scroll;">
                ...
                <asp:GridView ID="gvCustomers" runat="server" AutoGenerateColumns="false" PageSize="10" Width="1700px" Height="80"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField HeaderStyle-Width="20px" DataField="Tender_Date" HeaderText="Tender Date" AccessibleHeaderText="center" />
                        ...
                        <asp:BoundField HeaderStyle-Width="10px" DataField="Mill_Rate" HeaderText="Mill Rate" />
                        <asp:BoundField HeaderStyle-Width="50px" DataField="tenderdoname" HeaderText="Tender DO Name" />
                        <asp:BoundField HeaderStyle-Width="50px" DataField="season" HeaderText="season" />
                        <asp:BoundField HeaderStyle-Width="50px" DataField="brokername" HeaderText="Broker Name" />
                        <asp:BoundField HeaderStyle-Width="20px" DataField="Lifting_Date" HeaderText="Payment Date" />
                        <asp:BoundField HeaderStyle-Width="10px" DataField="tenderid" HeaderText="TenderID" />
                    </Columns>
                </asp:GridView>
                </center>
                <br />
