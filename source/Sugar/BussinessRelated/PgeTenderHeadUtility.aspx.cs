    ...
    public static string GetCustomers(string searchTerm, int pageIndex, int PageSize, int Company_Code, int year)
    {
        ...
        foreach (var s in split)
        {
            ...
            name += "( millshortname like '%" + aa + "%' or tenderdoname like '%" + aa + "%' or Grade like '%" + aa +
                ...
                "%' or Mill_Rate like '%" + aa + "%'or tenderid like '%" + aa + "%' or season like '%" + aa + "%' or brokername like '%" + aa + "%' or Lifting_DateConverted like '%" + aa + "%') and";
       ...
       + "millshortname ,Quantal,Grade,Mill_Rate,tenderdoname,season,brokername,Lifting_DateConverted as Lifting_Date,tenderid FROM qrytenderhead   where " + name + " and Company_Code=" + Company_Code + " " +
       " and Year_Code=" + year + " order by Tender_no desc";
