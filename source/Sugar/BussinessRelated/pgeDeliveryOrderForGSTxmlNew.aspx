...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function GEway() {
            ...
            window.open('../Utility/pgeEwayBill.aspx?dono=' + dono + '&Type=SB&ID=' + ID + '&carporateSale=' + carporateSale);
        }
        function EInovice() {
            var dono = document.getElementById('<%=txtdoc_no.ClientID %>').value;
            var ID = '';
            var carporateSale = document.getElementById('<%=txtcarporateSale.ClientID %>').value;
            window.open('../Utility/pgeEInovice.aspx?dono=' + dono + '&Type=SB&ID=' + ID + '&carporateSale=' + carporateSale);
        }
        function EInoviceEwayBill() {
            var dono = document.getElementById('<%=txtdoc_no.ClientID %>').value;
            var ID = '';
            var carporateSale = document.getElementById('<%=txtcarporateSale.ClientID %>').value;
            window.open('../Utility/pgeEInoviceAndEwayBill.aspx?dono=' + dono + '&Type=SB&ID=' + ID + '&carporateSale=' + carporateSale);
        }
...
function SelectRow(CurrentRow, RowIndex) {
    ...
    <script type="text/javascript">
        ...
        function pagevalidation() {
                    ...
                    if (TDSAc > 0) {
                        if (TDSAmt > 0) {
                            ...
                            XML = XML + "<Ledger TRAN_TYPE='DO' CASHCREDIT='' DOC_NO='" + doDoc_No + "' DOC_DATE='" + DOC_DATE + "' AC_CODE='" + TDSAc + "' " +
                                   "UNIT_code='0' NARRATION='" + DebitNarration + "' AMOUNT='" + TDSAmt + "' TENDER_ID='0' TENDER_ID_DETAIL='0' VOUCHER_ID='0' COMPANY_CODE='" + Company_Code + "' " +
                                   "YEAR_CODE='" + Year_Code + "' ORDER_CODE='" + Order_Code + "' DRCR='D' DRCR_HEAD='9999971' ADJUSTED_AMOUNT='0' Branch_Code='" + Branch_Code + "' " +
                            ...
                            XML = XML + "<Ledger TRAN_TYPE='DO' CASHCREDIT='' DOC_NO='" + doDoc_No + "' DOC_DATE='" + DOC_DATE + "' AC_CODE='" + Transporttdcac + "' " +
                                  "UNIT_code='0' NARRATION='" + CreditNarration + "' AMOUNT='" + TDSAmt + "' TENDER_ID='0' TENDER_ID_DETAIL='0' VOUCHER_ID='0' COMPANY_CODE='" + Company_Code + "' " +
                                  "YEAR_CODE='" + Year_Code + "' ORDER_CODE='" + Order_Code + "' DRCR='C' DRCR_HEAD='" + Transporttdcac + "' ADJUSTED_AMOUNT='0' Branch_Code='" + Branch_Code + "' " +
                ...
                if (DESP_TYPE == "DI" && (txtGETPASS_CODE == SELFAC || PDS == "P")) {
                    ...
                    if (voucherlbl == "" || voucherlbl == "0") {
                        XML = XML + "<PurchaseHead doc_no='" + purcDoc_No + "' Tran_Type='PS' PURCNO='" + doDoc_No + "' doc_date='" + PUR_DATE + "' " +
                                                ...
                                                "Modified_By='" + USER + "' Bill_No='" + MillInvoiceno + "' EWay_Bill_No='" + MillEwayBill + "' purchaseid='" + purcid + "' ac='" + PS_ac + "' uc='" + PS_uc + "' " +
                    ...
                    if (TOTALPurchase_Amount > 0) {
                        ...
                        XML = XML + "<Ledger TRAN_TYPE='PS' CASHCREDIT='' DOC_NO='" + purcDoc_No + "' DOC_DATE='" + PUR_DATE + "' AC_CODE='" + PaymentTo + "' " +
                          ...
                          "SORT_TYPE='PS' SORT_NO='" + purcDoc_No + "' ac='" + PS_ac + "' vc='0' progid='5' tranid='0'/>";
            ...
            "commission_amount='" + DIFF_RATE + "' resale_rate='" + Tender_Commission + "' resale_commission='" + Tender_Commission_Amount + "' misc_amount='0.00' " +
           ...
           "texable_amount='" + taxableamount + "' gst_code='" + txtGstRate + "' cgst_rate='" + lvcgstrate + "' cgst_amount='" + LV_CGSTAmount + "' " +
            ...
            "' Tran_Type='" + voucher_type + "' item_code='" + txtitem_Code + "' ic='" + ic + "' Frieght_Rate='" + MM_Rate + "' Frieght_amt='" + MEMO_ADVANCE + "' subtotal='" + DIFF_AMOUNT + "'/>";
        ...
        "texable_amount='" + taxableamount + "' gst_code='" + txtGstRate + "' cgst_rate='" + lvcgstrate + "' cgst_amount='" + LV_CGSTAmount + "' " +
         ...
         "' Tran_Type='" + voucher_type + "' item_code='" + txtitem_Code + "' ic='" + ic + "' Frieght_Rate='" + MM_Rate + "' Frieght_amt='" + MEMO_ADVANCE + "' subtotal='" + DIFF_AMOUNT + "'/>";
                        ...
                        if (Tender_Commission_Amount > 0) {
                            ...
                            XML = XML + "<Ledger TRAN_TYPE='" + voucher_type + "' CASHCREDIT='' DOC_NO='" + commiDoc_No + "' DOC_DATE='" + DOC_DATE + "' AC_CODE='" + '<%=Session["COMMISSION_AC"] %>' + "' " +
                                 "UNIT_code='0' NARRATION='' AMOUNT='" + Tender_Commission_Amount + "' TENDER_ID='0' TENDER_ID_DETAIL='0' VOUCHER_ID='0' COMPANY_CODE='" + Company_Code + "' " +
                                 "YEAR_CODE='" + Year_Code + "' ORDER_CODE='" + Order_Code + "' DRCR='" + drcr + "' DRCR_HEAD='0' ADJUSTED_AMOUNT='0' Branch_Code='" + Branch_Code + "' " +
                                 "SORT_TYPE='" + voucher_type + "' SORT_NO='" + commiDoc_No + "' ac='" + <%=Session["commissionid"] %> + "' vc='0' progid='11' tranid='0'/>";
                        }
                    }
            ...
            GSTRate = '<%= Session["GSTRate"] %>';
                ...
                var RATES = SALE_RATE + Tender_Commission + 0;
                var lessfrtwithgst = (SALE_RATE - FRIEGHT_RATE) + Tender_Commission + 0;
                ...
                TotalGstSaleBillAmount = parseFloat(TaxableAmountForSB + SB_CGSTAmount + SB_SGSTAmount + SB_IGSTAmount);
                ...
                if (DESP_TYPE != "DO" && txtSaleBillTo != "0" && txtSaleBillTo != SELFAC && txtSaleBillTo != "2") {
                    if (SbNo == "" || SbNo == "0") {
                        ...
                        XML = XML + "<SaleHead doc_no='" + saleDoc_No + "' Tran_Type='SB' PURCNO='" + purcDoc_No + "' Purcid='" + purcid + "' doc_date='" + DOC_DATE +
                            ...
                            "freight='" + SB_freight + "' cash_advance='0' bank_commission='0' OTHER_AMT='0' Bill_Amount='" + TotalGstSaleBillAmount + "' " +
                            ...
                            "' EwayBillValidDate='" + DOC_DATE + "' IsDeleted='1' TDS_Rate='" + SaleTDSrate + "' TDS_Amt='" + TDSAmt + "' SBNarration='" + SBNARRATION + "'>" +
                        ...
                        XML = XML + "<SaleHead doc_no='" + saleDoc_No + "' Tran_Type='SB' PURCNO='" + purcDoc_No + "' Purcid='" + purcid + "' doc_date='" + DOC_DATE + "' Ac_Code ='" + SB_Ac_Code + "' " +
                            ...
                            + "' bt='" + sbbt + "' EwayBillValidDate='" + EwayBill_ValidDate + "' IsDeleted='1' TDS_Rate='" + SaleTDSrate + "' TDS_Amt='" + TDSAmt + "' SBNarration='" + SBNARRATION + "'>" +
                            "<SaleDetail doc_no='" + saleDoc_No + "' detail_id='1' Tran_Type='SB' item_code='" + txtitem_Code + "' narration='' Quantal='" + txtquantal + "' packing='" + PACKING + "'  " +
                            "bags='" + BAGS + "' rate='" + SaleDetail_Rate + "'  " +
            ...
            if (TCSAmt > 0) {
                ...
                if (RecordStatus == "Save") {
                    ...
                    XML = XML + "<DoHead tran_type='DO' doc_no='" + DOC_NO + "' desp_type='" + DESP_TYPE + "' doc_date='" + DOC_DATE + "' mill_code='" + txtMILL_CODE + "' grade='" + txtGRADE + "' " +
                        ...
                        "diff_rate='" + difrate + "' diff_amount='" + DIFF_AMOUNT + "' amount='" + millamt + "' DO='" + DO_CODE + "' voucher_by='" + txtvoucher_by + "' broker='" + BROKER_CODE + "' " +
                  ...
                  "SalebilltoGstStateCode='" + txtSalebilltoGstStateCode + "' GstAmtOnMR='0.00' GstAmtOnSR='0.00' GstExlSR='0.00' GstExlMR='0.00' " +
                   ...
                   "va='" + va + "' carporate_ac='" + BillTo + "' ca='" + bt + "' mill_inv_date='" + MillInv_Date + "' mill_rcv='" + Inv_Chk + "' saleid='" + saleid + "' MillEwayBill='" + MillEwayBill + "' " +
                    ...
                    + TDSID + "' TDSRate='" + TDSRate + "' TDSAmt='" + TDSAmt + "' TDSCut='" + TDSCut_Chk + "' tenderid='" + TenderID +
                    "' MemoGSTRate='" + memogstrate + "' RCMCGSTAmt='" + memocgstamt + "' RCMSGSTAmt='" + memosgstamt + "' RCMIGSTAmt='" + memoigstamt +
                    "' RCMNumber='0' EwayBillValidDate='" + DOC_DATE + "' PurchaseTDSRate='" + PurchaseTDSrate + "' SaleTDSRate='" + SaleTDSrate + "' PurchaseRate='" + Purchase_Rate + "' SBNarration='" + SBNARRATION + "'>";
                   ...
                   "SalebilltoGstStateCode='" + txtSalebilltoGstStateCode + "' GstAmtOnMR='0.00' GstAmtOnSR='0.00' GstExlSR='0.00' GstExlMR='0.00' " +
                    ...
                    "' PurchaseTDSRate='" + PurchaseTDSrate + "' SaleTDSRate='" + SaleTDSrate + "' PurchaseRate='" + Purchase_Rate + "' SBNarration='" + SBNARRATION + "'>";
                ...
                for (var i = 1; i < grdrow.length; i++) {
                    ...
                    if (gridView.rows[i].cells[12].innerHTML == "A") {
                      ...
                      "DO_No='" + DOC_NO + "' UtrYearCode='' LTNo='" + LT_no + "' bc='" + bc + "' utrdetailid='" + UTRDetail_ID + "' dodetailid='" + ddid + "' doid='" + doid + "'/>";
                      ...
                      "Company_Code='" + Company_Code + "' Year_Code='" + Year_Code + "' Branch_Code='" + Branch_Code + "' UTR_NO='" + Utr_no
                      + "' DO_No='" + DOC_NO + "' UtrYearCode='' LTNo='" + LT_no + "' bc='" + bc + "' utrdetailid='" + UTRDetail_ID +
                    ...
                    <table cellspacing="5" align="left">
                                    ...
                                    <tr>
                                        <td align="left" colspan="8">
                                            ...
                                            <asp:Button OnClientClick="if (!Validate()) return false;" ID="btnSave" runat="server" Text="Save" CssClass="btnHelp" Width="90px"
                                                TabIndex="65" ValidationGroup="add" OnClick="btnSave_Click" UseSubmitBehavior="false"
                                                Height="24px" />
                                            &nbsp;
                                            <asp:Button ID="btnEdit" runat="server" Text="Edit" CssClass="btnHelp" Width="90px"
                                                TabIndex="66" ValidationGroup="save" OnClick="btnEdit_Click" Height="24px" />
                                            &nbsp;
                                            <asp:Button ID="btnDelete" runat="server" Text="Delete" CssClass="btnHelp" Width="90px"
                                                TabIndex="67" ValidationGroup="add" OnClick="btnDelete_Click" OnClientClick="return Confirm(this, event);" Height="24px" />
                                            &nbsp;
                                            <asp:Button ID="btnCancel" runat="server" Text="Cancel" CssClass="btnHelp" Width="90px"
                                                TabIndex="68" ValidationGroup="save" OnClick="btnCancel_Click" Height="24px" />
                                            &nbsp;
                                            <asp:Button ID="btnBack" runat="server" Text="Back" CssClass="btnHelp" Width="90px"
                                                TabIndex="69" ValidationGroup="save" Height="24px" OnClientClick="Back()" />

                                        </td>
                                        <td align="center">
                                            <asp:Button ID="btnFirst" runat="server" Text="<<" ToolTip="First" CssClass="btnHelp"
                                                OnClick="btnFirst_Click" Width="90px" Height="24px" TabIndex="49" />
                                            <asp:Button ID="btnPrevious" runat="server" Text="<" ToolTip="Previous" CssClass="btnHelp"
                                                OnClick="btnPrevious_Click" Width="90px" Height="24px" TabIndex="50" />
                                            <asp:Button ID="btnNext" runat="server" Text=">" ToolTip="Next" CssClass="btnHelp"
                                                OnClick="btnNext_Click" Width="90px" Height="24px" TabIndex="51" />
                                            <asp:Button ID="btnLast" runat="server" Text=">>" ToolTip="Last" CssClass="btnHelp"
                                                OnClick="btnLast_Click" Width="90px" Height="24px" TabIndex="52" />
                                        </td>
                                    </tr>
                                </table>
                            </td>
                        ...
                        <tr>
                            ...
                            <td align="left" colspan="6">
                                ...
                                <asp:TextBox ID="txtPACKING" runat="Server" CssClass="txt" Width="100px" Style="text-align: right;"
                                    TabIndex="22" AutoPostBack="True" OnTextChanged="txtPACKING_TextChanged" Height="24px"></asp:TextBox>
                                ...
                                &nbsp;&nbsp;&nbsp;Bags:&nbsp;&nbsp;<asp:TextBox ID="txtBAGS" runat="Server" CssClass="txt"
                                    TabIndex="23" Width="100px" ReadOnly="true" Style="text-align: right;" AutoPostBack="True"
                                ...
                                <asp:TextBox ID="txtexcise_rate" runat="Server" CssClass="txt" Width="100px" Style="text-align: right;"
                                    TabIndex="24" AutoPostBack="True" OnTextChanged="txtexcise_rate_TextChanged"
                                    Height="24px"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td align="left" colspan="6" style="vertical-align: top;">
                                <asp:TextBox ID="txtmillRate" runat="Server" CssClass="txt" Width="100px"
                                    ...
                                    Height="24px" TabIndex="25" ReadOnly="true"></asp:TextBox>
                                ...
                                <asp:TextBox ID="txtSALE_RATE" runat="Server" CssClass="txt" Width="100px" Style="text-align: right;"
                                    TabIndex="26" AutoPostBack="True" OnTextChanged="txtSALE_RATE_TextChanged" Height="24px"></asp:TextBox>
                                ...
                                <asp:TextBox ID="txtpurchaserate" runat="Server" CssClass="txt" Width="100px" Style="text-align: right;"
                                    TabIndex="26" AutoPostBack="True" OnTextChanged="txtpurchaserate_TextChanged" Height="24px"></asp:TextBox>
                                ...
                                <asp:TextBox ID="txtCashDiff" runat="Server" CssClass="txt" Width="100px" Style="text-align: right;"
                                    TabIndex="27" AutoPostBack="True" OnTextChanged="txtCashDiff_TextChanged" Height="24px"></asp:TextBox>


                                <asp:Label ID="lblCashdiffvalue" runat="server" CssClass="lblName" ForeColor="Yellow"></asp:Label>
                                &nbsp;&nbsp; 
                                Cash Diff Ac:
                                <asp:TextBox ID="txtCashDiffAc" runat="Server" CssClass="txt" TabIndex="28" Width="80px"
                        ...
                        <tr>
                            ...
                            <td align="left" colspan="6" style="vertical-align: top;">
                                <asp:TextBox runat="server" ID="txtCommission" Width="50px"
                                    TabIndex="29" AutoPostBack="true" Height="24px" CssClass="txt" OnTextChanged="txtCommission_TextChanged" />
                                &nbsp;&nbsp;&nbsp;Diff:
                                ...
                                <asp:TextBox ID="txtTCSRate_Sale" runat="Server" CssClass="txt" Width="42px" AutoPostBack="true"
                                    OnTextChanged="txtTCSRate_Sale_TextChanged" TabIndex="31" Style="text-align: right;"
                                    Height="24px"></asp:TextBox>
                                ...
                                <asp:TextBox ID="txtPurchaseTDS" runat="Server" CssClass="txt" Width="42px" AutoPostBack="true"
                                    OnTextChanged="txtPurchaseTDS_TextChanged" TabIndex="30" Style="text-align: right;"
                                    Height="24px"></asp:TextBox>
                                &nbsp;&nbsp;&nbsp;Sale TDS%
                                <asp:TextBox ID="txtSaleTDS" runat="Server" CssClass="txt" Width="42px" AutoPostBack="true"
                                    OnTextChanged="txtSaleTDS_TextChanged" TabIndex="31" Style="text-align: right;"
                                    Height="24px"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td align="left" style="width: 20%; border-bottom: 3px solid white;" colspan="6">
                                <asp:TextBox ID="txtTruck_NO" runat="Server" CssClass="txt" TabIndex="32" Width="140px"
                                ...
                                <asp:TextBox runat="server" ID="txtDriverMobile" CssClass="txt" TabIndex="33" Width="140px"
                                ...
                                &nbsp; Transport:
                                <asp:TextBox ID="txtTRANSPORT_CODE" runat="Server" CssClass="txt" TabIndex="34" Width="80px"
                                ...
                                <asp:TextBox ID="txtTransportGstStateCode" runat="Server" CssClass="txt" Width="80px"
                                    TabIndex="35" onkeydown="transportstatecode(event);" Style="text-align: right;"
                        ...
                        <tr>
                            ...
                            <td align="left" style="width: 10%;" colspan="3">
                                <asp:TextBox ID="txtDIFF_AMOUNT" runat="Server" CssClass="txt" Width="100px" ReadOnly="true"
                                    TabIndex="36" Style="text-align: right;" AutoPostBack="True" OnTextChanged="txtDIFF_AMOUNT_TextChanged"
                                    Height="24px"></asp:TextBox>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Frieght:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:TextBox
                                    TabIndex="37" runat="server" ID="txtFrieght" CssClass="txt" Width="100px" Style="text-align: right;"
                                ...
                                <asp:TextBox runat="server" ID="txtFrieghtAmount" CssClass="txt" AutoPostBack="false"
                                    TabIndex="38" ReadOnly="true" Height="24px" Width="100px" Style="text-align: right;"
                                ...
                                &nbsp;rate:<asp:TextBox runat="server" ID="txtMemoAdvanceRate" Width="40px" Height="24px"
                                    TabIndex="40" AutoPostBack="true" CssClass="txt" OnTextChanged="txtMemoAdvanceRate_TextChanged"></asp:TextBox>
                                <asp:TextBox runat="server" ID="txtMemoAdvance" CssClass="txt" Width="100px" Style="text-align: right;"
                                    TabIndex="41" AutoPostBack="true" Height="24px" OnTextChanged="txtMemoAdvance_TextChanged"></asp:TextBox>
                                ...
                                <asp:TextBox ID="txtMemoGSTRate" runat="Server" CssClass="txt" Width="80px"
                                    TabIndex="42" onkeydown="MemoGSTRate(event);" Style="text-align: right;"
                        ...
                        <tr>
                            ...
                            <td align="left" style="width: 10%;" colspan="3">
                                <asp:TextBox ID="txtTDSAc" runat="Server" CssClass="txt" TabIndex="43" Width="80px"
                                ...
                                TDS %:<asp:TextBox runat="server" ID="txttdsrate" Width="40px" Height="24px"
                                    TabIndex="44" AutoPostBack="true" CssClass="txt" OnTextChanged="txttdsrate_TextChanged"></asp:TextBox>
                                <asp:TextBox runat="server" ID="txttdsamount" CssClass="txt" Width="100px" Style="text-align: right;"
                                    TabIndex="45" AutoPostBack="true" Height="24px" OnTextChanged="txttdsamount_TextChanged"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td align="left" colspan="5">
                                <asp:TextBox runat="server" ID="txtVasuliRate" CssClass="txt" Width="100px" Style="text-align: right;"
                                    TabIndex="46" AutoPostBack="true" Height="24px" OnTextChanged="txtVasuliRate_TextChanged"></asp:TextBox>
                                <asp:TextBox runat="server" ID="txtVasuliAmount" CssClass="txt" AutoPostBack="true"
                                    TabIndex="47" OnTextChanged="txtVasuliAmount_TextChanged" Height="24px" Width="100px"
                                    Style="text-align: right;"></asp:TextBox>&nbsp;&nbsp;&nbsp; Vasuli Rate:<asp:TextBox
                                        runat="server" ID="txtVasuliRate1" CssClass="txt" Width="80px" TabIndex="48"
                                ...
                                <asp:TextBox runat="server" ID="txtVasuliAmount1" CssClass="txt" Width="100px" Style="text-align: right;"
                                    TabIndex="49" AutoPostBack="true" OnTextChanged="txtVasuliAmount1_TextChanged"
                                ...
                                <asp:TextBox ID="txtVasuliAc" runat="Server" CssClass="txt" Width="80px" Style="text-align: right;"
                                    TabIndex="50" onkeydown="vasuli(event);" AutoPostBack="false" OnTextChanged="txtVasuliAc_TextChanged"
                                    Height="24px"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td align="left" colspan="5">
                                <asp:TextBox ID="txtDO_CODE" runat="Server" CssClass="txt" Width="120px" Style="text-align: right;"
                                    TabIndex="51" onkeydown="docode(event);" AutoPostBack="false" OnTextChanged="txtDO_CODE_TextChanged"
                                    Height="24px"></asp:TextBox>
                                ...
                                <asp:TextBox ID="txtMillEwayBill_No" runat="Server" CssClass="txt" Width="150px"
                                    TabIndex="52" Style="text-align: left;" Height="24px"></asp:TextBox>
                                <asp:TextBox ID="txtMillInvoiceno" runat="Server" CssClass="txt" Width="150px" Style="text-align: left;"
                                    TabIndex="53" Height="24px"></asp:TextBox>

                                mill Invoice Date:
                                  <asp:TextBox ID="txtMillInv_Date" runat="Server" CssClass="txt" Width="80px"
                                      TabIndex="54" MaxLength="10" onkeyup="ValidateDate(this,event.keyCode)" onkeydown="return DateFormat(this,event.keyCode)"
                                ...
                                <asp:CheckBox runat="server" ID="chkEWayBill" TabIndex="55" AutoPostBack="true" OnCheckedChanged="chkEWayBill_CheckedChanged" />
                                ...
                                My EWay Bill No: 
                                  <asp:TextBox ID="txtEWayBill_No" runat="Server" CssClass="txt" Width="150px" Style="text-align: left;"
                                      TabIndex="56" Height="24px"></asp:TextBox>
                                EWayBill ValidDate : 
                        ...
                        <tr>
                            ...
                            <td align="left" colspan="5">
                                <asp:TextBox ID="txtBroker_CODE" runat="Server" CssClass="txt" Width="120px" Style="text-align: right;"
                                    TabIndex="57" onkeydown="broker(event);" AutoPostBack="false" OnTextChanged="txtBroker_CODE_TextChanged"
                                    Height="24px"></asp:TextBox>
                                ...
                                Distance:
                                <asp:TextBox ID="txtDistance" runat="Server" CssClass="txt" TabIndex="58" Width="80px"
                                ...
                                Invoice Checked:<asp:CheckBox runat="server"
                                    TabIndex="59" ID="chkInv_Chk" Width="10px" Height="10px" />
                                Season
                                <asp:TextBox ID="txtseasons" runat="Server" CssClass="txt" TabIndex="58" Width="80px"
                        ...
                        <tr>
                            ...
                            <td align="left" colspan="5">
                                <asp:TextBox ID="txtNARRATION1" runat="Server" CssClass="txt" Width="400px" Style="text-align: left;"
                                    TabIndex="60" onkeydown="narration1(event);" AutoPostBack="True" OnTextChanged="txtNARRATION1_TextChanged"
                                    Height="24px"></asp:TextBox>
                                ...
                                <asp:TextBox ID="txtNARRATION2" runat="Server" CssClass="txt" Width="200px" Style="text-align: left;"
                                    TabIndex="61" onkeydown="narration2(event);" AutoPostBack="True" OnTextChanged="txtNARRATION2_TextChanged"
                                    Height="24px"></asp:TextBox>
                                ...
                                <asp:TextBox ID="txtNARRATION3" runat="Server" CssClass="txt" Width="200px" Style="text-align: left;"
                                    TabIndex="62" onkeydown="narration3(event);" AutoPostBack="True" OnTextChanged="txtNARRATION3_TextChanged"
                                    Height="24px"></asp:TextBox>
                        ...
                        <tr>
                            <td align="left">
                                <asp:Button ID="btnOpenDetailsPopup" runat="server" Text="ADD" CssClass="btnHelp"
                                    TabIndex="65" Width="80px" Height="24px" OnClick="btnOpenDetailsPopup_Click" />&nbsp;&nbsp;&nbsp;
                            </td>
                ...
                <table width="80%" align="center" cellspacing="5px">
                    ...
                    <tr>
                        ...
                        <td align="left" style="width: 10%;">
                            <asp:DropDownList ID="drpddType" runat="server" CssClass="ddl" TabIndex="63" Width="200px"
                                Height="30px">
                    ...
                    <tr>
                        ...
                        <td align="left" style="width: 10%;">
                            <asp:TextBox ID="txtBANK_CODE" runat="Server" CssClass="txt" TabIndex="64" Width="60px"
                    ...
                    <tr>
                        ...
                        <td colspan="2" align="left">
                            <asp:TextBox ID="txtUTRNo" CssClass="txt" Width="80px" runat="server" AutoPostBack="true"
                                onkeydown="UTR(event);" OnTextChanged="txtUTRNo_TextChanged" TabIndex="65" Height="24px"></asp:TextBox>
                            <asp:Button ID="btntxtUTRNo" runat="server" CssClass="btnHelp" Text="UTR No" Width="80px"
                    ...
                    <tr>
                        ...
                        <td align="left" style="width: 10%;">
                            <asp:TextBox ID="txtNARRATION" runat="Server" CssClass="txt" TabIndex="67" Height="24px"
                    ...
                    <tr>
                        ...
                        <td align="left" style="width: 10%;">
                            <asp:TextBox ID="txtBANK_AMOUNT" runat="Server" CssClass="txt" TabIndex="68" Height="24px"
                    ...
                    <tr>
                        ...
                        <td align="left" style="width: 10%;">
                            <asp:TextBox ID="txtwithGst_Amount" runat="Server" CssClass="txt" TabIndex="69" Height="24px"
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtLT_No" runat="Server" CssClass="txt" TabIndex="70" Height="24px"
                    ...
                    <tr>
                        <td colspan="2" align="left">
                            <asp:Button ID="btnAdddetails" runat="server" Text="ADD" CssClass="btnSubmit" Width="80px"
                                Height="25px" OnClick="btnAdddetails_Click" TabIndex="71" />
                            <asp:Button ID="btnClosedetails" runat="server" Text="Close" CssClass="btnSubmit"
                                Width="80px" Height="25px" OnClick="btnClosedetails_Click" TabIndex="72" />
                        </td>
                    </tr>
                </table>
            </asp:Panel>
