        ...
        function SelectSibling(e) {
            ...
            if (KeyCode == 40) {
                ...
                if (hdnfClosePopupValue == "txtmillcode") {
                    ...
                    document.getElementById("<%=txtmillcode.ClientID %>").value = grid.rows[SelectedRowIndex + 1].cells[9].innerText;
                    ...
                    document.getElementById("<%=hdnfID.ClientID %>").value = grid.rows[SelectedRowIndex + 1].cells[13].innerText;        
                    ...
                    document.getElementById("<%=lblmillrate.ClientID %>").innerText = grid.rows[SelectedRowIndex + 1].cells[5].innerText;
                    document.getElementById("<%=lblseason.ClientID %>").innerText = grid.rows[SelectedRowIndex + 1].cells[8].innerText;
                    document.getElementById("<%=lblpurcrate.ClientID %>").innerText = grid.rows[SelectedRowIndex + 1].cells[9].innerText;
                    document.getElementById("<%=txtDetailLiftingDate.ClientID %>").value = grid.rows[SelectedRowIndex + 1].cells[2].innerText;
        ...
        <ContentTemplate>
            ...
            <asp:Panel ID="pnlMain" runat="server" Font-Names="verdana" Font-Bold="true" ForeColor="Black"
                ...
                <table style="width: 60%;" align="center" cellpadding="4" cellspacing="4">
                    ...
                    <tr>
                        ...
                        <td align="left" style="width: 20%;">
                            <asp:TextBox ID="txtBuyerQuantal" runat="server" Width="80px" Height="24px" CssClass="txt"
                                AutoPostBack="true" OnTextChanged="txtBuyerQuantal_TextChanged" TabIndex="6"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td align="left" style="width: 20%;">
                            <asp:TextBox ID="txtBuyerSaleRate" runat="server" Width="80px" Height="24px" CssClass="txt"
                                AutoPostBack="true" OnTextChanged="txtBuyerSaleRate_TextChanged" TabIndex="7"></asp:TextBox>
                    ...
                    <tr>
                        <td align="right" style="width: 30%;">Cash Diff.
                        </td>
                        <td align="left" style="width: 20%;">
                            <asp:TextBox ID="txtcashdifference" runat="server" Width="80px" Height="24px" CssClass="txt"
                                AutoPostBack="true" OnTextChanged="txtcashdifference_TextChanged" TabIndex="8"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td align="left" style="width: 20%;">
                            <asp:TextBox ID="txtBuyerCommission" runat="server" CssClass="txt" Height="24px"
                                TabIndex="9" Width="80px" AutoPostBack="true" OnTextChanged="txtBuyerCommission_TextChanged"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td align="left" style="width: 20%;">
                            <asp:TextBox ID="txtDetailLiftingDate" runat="server" CssClass="txt" Width="100px"
                                ...
                                TabIndex="11" Height="24px"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td align="left" style="width: 20%;">
                            <asp:TextBox ID="txtBuyerNarration" runat="server" Width="360px" CssClass="txt" Height="50px"
                                TextMode="MultiLine" TabIndex="12" AutoPostBack="true" OnTextChanged="txtBuyerNarration_TextChanged"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td align="left" style="width: 20%;">
                            <asp:TextBox ID="txtGSTrate" runat="server" Width="60px" CssClass="txt" Height="24px"
                                TabIndex="13" AutoPostBack="true" OnTextChanged="txtGSTrate_TextChanged"></asp:TextBox>

                            <asp:TextBox ID="txtgstamt" runat="server" Width="100px" CssClass="txt" Height="24px"
                                TabIndex="14" AutoPostBack="true"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td align="left" style="width: 20%;">
                            <asp:TextBox ID="txtTCSrate1" runat="server" Width="60px" CssClass="txt" Height="24px"
                                TabIndex="15" AutoPostBack="true" OnTextChanged="txtTCSrate1_TextChanged"></asp:TextBox>

                            <asp:TextBox ID="txtTCSamount1" runat="server" Width="100px" CssClass="txt" Height="24px"
                                TabIndex="16" AutoPostBack="true"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr align="right">
                        <td>
                            <asp:Button ID="btnUpdate" runat="server" Text="Update" CssClass="btnHelp" TabIndex="17"
