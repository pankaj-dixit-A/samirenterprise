    ...
    public static string GetCustomers(string searchTerm, int pageIndex, string Trantype, int PageSize, int Company_Code, int year)
    {
        ...
        foreach (var s in split)
        {
            ...
            name += "( millshortname like '%" + aa + "%' or billtoshortname like  '%" + aa + "%' or doc_dateConverted like '%" + aa +
                ...
                + aa + "%' or SB_No like '%" + aa + "%'or doid like '%" + aa + "%' or  truck_no like '%" + aa + "%' or  shiptoshortname like '%" + aa + "%' or  shiptocityname like '%" + aa + "%'or  salebillcityname like '%" + aa + "%' or  EWay_Bill_No like '%" + aa + "%' or  Delivery_Type like '%" + aa + "%'or  transportshortname like '%" + aa + "%') and";
        ...
        string query = "";
         ...
         + " purc_no,purc_order,millshortname,quantal,billtoshortname,salebillcityname,shiptoshortname,shiptocityname,sale_rate,Tender_Commission,desp_type ,truck_no,SB_No,EWay_Bill_No,Delivery_Type,transportshortname,doid FROM qrydohead   where " + name + " and desp_type='" + Trantype + "' and Company_Code=" + Company_Code + " " +
