...
function SelectRow(CurrentRow, RowIndex) {
    ...
    <script type="text/javascript">
        ...
        function Validate() {
            ...
            if ($("#<%=txtCashDiff.ClientID %>").val() != "" && $("#<%=txtCashDiff.ClientID %>").val() != "0" && $("#<%=txtCashDiff.ClientID %>").val() != "0.00") {
                ...
                if ($("#<%=txtBroker.ClientID %>").val() == "" || $("#<%=txtBroker.ClientID %>").val() == "2") {
    ...
    "commission_amount='0.00' resale_rate='0.00' resale_commission='0.00' misc_amount='0.00' " +
    ...
    + itemcode + "' ic='" + ic + "' Frieght_Rate='0' Frieght_amt='0' subtotal='" + taxmillamt + "' IsTDS='" + IsTDS + "' TDS_Ac='" + tdsAc + "' TDS_Per='" + tds + "'  TDSAmount='" + TDSamount + "'  TDS='" + tds + "' ta='" + pt + "' ></Commission>";
                    ...
                    XML = XML + "<Ledger TRAN_TYPE='" + voucher_type + "' CASHCREDIT='' DOC_DATE='" + Tender_Date + "' AC_CODE='" + Voucher_By + "' " +
                          "UNIT_code='0' NARRATION='' AMOUNT='" + taxmillamt + "' TENDER_ID='0' TENDER_ID_DETAIL='0' VOUCHER_ID='0' COMPANY_CODE='" + Company_Code + "' " +
                          "YEAR_CODE='" + Year_Code + "' ORDER_CODE='" + Order_Code + "' DRCR='" + drcr + "' DRCR_HEAD='0' ADJUSTED_AMOUNT='0' Branch_Code='" + Branch_Id + "' " +
                          "SORT_TYPE='" + voucher_type + "' SORT_NO='" + commiDoc_No + "' ac='" + vb + "' vc='0' progid='11' tranid='0' saleid='" + vb + "'/>";
                    ...
                    if (voucher_type == "LV") {
                        ...
                        XML = XML + "<Ledger TRAN_TYPE='" + voucher_type + "' CASHCREDIT='' DOC_DATE='" + Tender_Date + "' AC_CODE='" + Voucher_By + "' " +
                              "UNIT_code='0' NARRATION='TCS' AMOUNT='" + LV_TCSAmt + "' TENDER_ID='0' TENDER_ID_DETAIL='0' VOUCHER_ID='0' COMPANY_CODE='" + Company_Code + "' " +
                        ...
                        XML = XML + "<Ledger TRAN_TYPE='" + voucher_type + "' CASHCREDIT='' DOC_DATE='" + Tender_Date + "' AC_CODE='" + '<%=Session["SaleTCSAc"] %>' + "' " +
                              ...
                              "SORT_TYPE='" + voucher_type + "' SORT_NO='" + commiDoc_No + "' ac='" + vb + "' vc='0' progid='11' tranid='0' saleid='" + '<%=Session["SaleTCSAc"] %>' + "'/>";
                    }
                    else {
                        Order_Code = parseInt(Order_Code) + 1;
    ...
    + itemcode + "' ic='" + ic + "' Frieght_Rate='0' Frieght_amt='0' subtotal='" + taxmillamt + "' IsTDS='" + IsTDS + "' TDS_Ac='" + tdsAc + "' TDS_Per='" + tds + "'  TDSAmount='" + TDSamount + "'  TDS='" + tds + "' ta='" + pt + "'></Commission>";
      ...
      "Payment_To='" + Payment_To + "' Tender_From='" + Tender_From + "' Tender_DO='" + Tender_DO + "' Voucher_By='" + Voucher_By + "' " +
      ...
      "' Voucher_Type='" + voucher_type + "' commissionid='" + commisionid + "' Party_Bill_Rate='" + party_Bill_rate + "' TDS_Rate='" + TDS_Rate + "' TDS_Amt='" + TDS_Amt + "'>";
            //Detail Calculation
        ...
        for (var i = 1; i < grdrow.length; i++) {
            ...
            if (gridView.rows[i].cells[20].innerHTML != "N") {
               ...
               "' tcs_amt='" + tcsamt1 + "' gst_amt='" + GSTamt1 + "' ShipTo='" + Shipto + "' CashDiff='" + Cashdiff + "' shiptoid='" + shiptoid + "'/>";
                    ddi = parseInt(ddi) + 1;
                }
                    ...
                    XML = XML + "<TenderDetail Tender_No='" + TenderNo + "' Company_Code='" + Company_Code + "' Buyer='" + Party + "' Buyer_Quantal='" + DQty + "' " +
                                       ...
                                       "sub_broker='" + SubBroker + "' sbr='" + Sbc + "' tcs_rate='" + tcsrate1 + "' gst_rate='" + GSTrate1 + "' tcs_amt='" + tcsamt1 + "' gst_amt='" + GSTamt1 + "' ShipTo='" + Shipto + "' CashDiff='" + Cashdiff + "' shiptoid='" + shiptoid + "'/>";
                }
            ...
            <asp:Panel ID="pnlMain" runat="server" Font-Names="verdana" Font-Bold="True" ForeColor="Black"
                ...
                <table width="100%" align="left" cellspacing="4px" cellpadding="1px">
                                ...
                                <tr>
                                    <td align="center">
                                        ...
                                        <asp:Button OnClientClick="if (!Validate()) return false;" ID="btnSave" runat="server" Text="Save" CssClass="btnHelp" Width="80px"
                                            UseSubmitBehavior="false" Height="25px" ValidationGroup="add" OnClick="btnSave_Click" TabIndex="34" />
                                        &nbsp;
                        ...
                        <td align="left" colspan="4">
                            ...
                            C.A:
                             <asp:TextBox ID="txtCashDiff" runat="server" AutoPostBack="false" CssClass="txt" Width="100px"
                                 OnTextChanged="txtCashDiff_TextChanged" TabIndex="14" Height="24px"></asp:TextBox>
                            &nbsp;&nbsp;&nbsp;Diff:
                    ...
                    <tr>
                        ...
                        <td colspan="6" align="left">
                            <asp:TextBox ID="txtPaymentTo" runat="server" CssClass="txt" Width="100px" Style="text-align: right;"
                                AutoPostBack="false" OnTextChanged="txtPaymentTo_TextChanged" TabIndex="15" Height="24px" onkeydown="PaymentTo(event);"></asp:TextBox>
                            ...
                            Tender From:
                            <asp:TextBox ID="txtTenderFrom" runat="server" CssClass="txt" Width="100px" TabIndex="16"
                    ...
                    <tr>
                        ...
                        <td colspan="6" align="left">
                            <asp:TextBox ID="txtDO" runat="server" CssClass="txt" Width="100px" TabIndex="17"
                            ...
                            <asp:TextBox ID="txtVoucherBy" runat="server" CssClass="txt" Width="100px" Style="text-align: right;"
                                AutoPostBack="false" OnTextChanged="txtVoucherBy_TextChanged" TabIndex="18" Height="24px" onkeydown="VoucherBy(event);"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td colspan="4" align="left">
                            <asp:TextBox ID="txtBroker" runat="server" CssClass="txt" Width="100px" Style="text-align: right;"
                                AutoPostBack="false" OnTextChanged="txtBroker_TextChanged" TabIndex="19" Height="24px" onkeydown="broker(event);"></asp:TextBox>
                            ...
                            <asp:Label ID="lblBroker_Id" runat="server" CssClass="lblName"></asp:Label>&nbsp;&nbsp;Brokrage:<asp:TextBox
                                runat="server" ID="txtBrokrage" CssClass="txt" Width="80px" Height="24px" TabIndex="20" />
                            &nbsp;&nbsp; GST Rate Code
                       <asp:TextBox ID="txtGstrateCode" runat="server" CssClass="txt" Width="100px" Style="text-align: right;"
                           AutoPostBack="false" OnTextChanged="txtGstrateCode_TextChanged" TabIndex="21" Height="24px" onkeydown="gstRateCode(event);"></asp:TextBox>
                            ...
                            <asp:TextBox ID="txtExciseRate" runat="server" CssClass="txt" TabIndex="22" Width="100px"
                         ...
                         Value:<asp:Label Text="" runat="server" ID="lblValue" ForeColor="Yellow" />
                            Sell Note No:<asp:TextBox runat="server" ID="txtSellNoteNo" Width="150px" Height="24px"
                                TabIndex="23" Style="text-align: right;" CssClass="txt" OnTextChanged="txtSellNoteNo_TextChanged"></asp:TextBox>&nbsp;&nbsp;
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td colspan="4" align="left">
                            ...
                            <asp:TextBox ID="txtNarration" runat="server" CssClass="txt" TabIndex="24" AutoPostBack="True"
                            ...
                            <asp:TextBox ID="txtTCSRate" runat="Server" CssClass="txt" Width="50px" AutoPostBack="true"
                                OnTextChanged="txtTCSRate_TextChanged" TabIndex="25" Style="text-align: right;"
                                Height="24px"></asp:TextBox>
                            ...
                            <asp:TextBox ID="txtTdsrate" runat="Server" CssClass="txt" Width="50px" AutoPostBack="true"
                                OnTextChanged="txtTdsrate_TextChanged" TabIndex="24" Style="text-align: right;"
                                Height="24px"></asp:TextBox>
                        ...
                        <tr>
                            <td align="left">Bill To:
                                ...
                                <asp:TextBox ID="txtBuyer" runat="server" Width="80px" Height="24px" AutoPostBack="false"
                                    CssClass="txt" OnTextChanged="txtBuyer_TextChanged" onkeydown="Party(event);" TabIndex="25"></asp:TextBox>
                                ...
                                Ship To:
                                 <asp:TextBox ID="txtShipTo" runat="server" Width="80px" Height="24px" AutoPostBack="false"
                                     CssClass="txt" OnTextChanged="txtShipTo_TextChanged" onkeydown="Shipto(event);" TabIndex="26"></asp:TextBox>
                                <%--<ajax1:FilteredTextBoxExtender runat="server" ID="filtertxtBuyer" FilterType="Numbers" TargetControlID="txtBuyer"></ajax1:FilteredTextBoxExtender>--%>
                                ...
                                Delivery Type:
                                   <asp:DropDownList ID="drpDeliveryType" runat="server" CssClass="ddl" Width="240px"
                                       TabIndex="27" AutoPostBack="true" Height="26px" OnSelectedIndexChanged="drpDeliveryType_SelectedIndexChanged">
                        ...
                        <tr>
                            <td align="left">Broker:
                                ...
                                <asp:TextBox ID="txtBuyerParty" runat="server" Width="80px" CssClass="txt" Height="24px"
                                    OnTextChanged="txtBuyerParty_TextChanged" AutoPostBack="false" onkeydown="detailBroker(event);" TabIndex="28"></asp:TextBox>
                                ...
                                Sub Broker:
                                  <asp:TextBox ID="txtsubBroker" runat="server" Width="80px" CssClass="txt" Height="24px"
                                      OnTextChanged="txtsubBroker_TextChanged" AutoPostBack="false" onkeydown="subBroker(event);" TabIndex="29"></asp:TextBox>
                                <%--<ajax1:FilteredTextBoxExtender runat="server" ID="filtertxtBuyerParty" FilterType="Numbers" TargetControlID="txtBuyerParty"></ajax1:FilteredTextBoxExtender>--%>
                                ...
                                <asp:TextBox ID="txtBuyerQuantal" runat="server" Width="80px" Height="24px" CssClass="txt"
                                    AutoPostBack="true" OnTextChanged="txtBuyerQuantal_TextChanged" TabIndex="30"></asp:TextBox>
                                ...
                                <asp:TextBox ID="txtBuyerSaleRate" runat="server" Width="80px" Height="24px" CssClass="txt"
                                    AutoPostBack="true" OnTextChanged="txtBuyerSaleRate_TextChanged" TabIndex="31"></asp:TextBox>
                                ...
                                <asp:TextBox ID="txtcashdifference" runat="server" Width="80px" Height="24px" CssClass="txt"
                                    AutoPostBack="true" OnTextChanged="txtcashdifference_TextChanged" TabIndex="32"></asp:TextBox>
                                ...
                                <asp:TextBox ID="txtBuyerCommission" runat="server" CssClass="txt" Height="24px"
                                    TabIndex="33" Width="80px" AutoPostBack="true" OnTextChanged="txtBuyerCommission_TextChanged"></asp:TextBox>
                        ...
                        <tr>
                            <td align="left">Sauda Date:
                                ...
                                <asp:TextBox ID="txtDetailSaudaDate" runat="server" CssClass="txt" Width="100px"
                                    ...
                                    TabIndex="34" Height="24px"></asp:TextBox>
                                ...
                                <asp:TextBox ID="txtDetailLiftingDate" runat="server" CssClass="txt" Width="100px"
                                    ...
                                    TabIndex="35" Height="24px"></asp:TextBox>
                                ...
                                <asp:TextBox ID="txtBuyerNarration" runat="server" Width="360px" CssClass="txt" Height="50px"
                                    TextMode="MultiLine" TabIndex="35" AutoPostBack="true" OnTextChanged="txtBuyerNarration_TextChanged"></asp:TextBox>
                        ...
                        <tr>
                            <td>GST Amount
                                ...
                                <asp:TextBox ID="txtGSTrate" runat="server" Width="60px" CssClass="txt" Height="24px"
                                    TabIndex="36" AutoPostBack="true" OnTextChanged="txtGSTrate_TextChanged"></asp:TextBox>

                                <asp:TextBox ID="txtgstamt" runat="server" Width="100px" CssClass="txt" Height="24px"
                                    TabIndex="37" AutoPostBack="true"></asp:TextBox>
                                TCS Amount
                           
                                <asp:TextBox ID="txtTCSrate1" runat="server" Width="60px" CssClass="txt" Height="24px"
                                    TabIndex="38" AutoPostBack="true" OnTextChanged="txtTCSrate1_TextChanged"></asp:TextBox>

                                <asp:TextBox ID="txtTCSamount1" runat="server" Width="100px" CssClass="txt" Height="24px"
                                    TabIndex="39" AutoPostBack="true"></asp:TextBox>
                                ...
                                <asp:Button ID="btnClose" runat="server" Text="Close" OnClick="btnClose_Click" CssClass="btnHelp"
                                    TabIndex="41" Font-Bold="false" CausesValidation="false" Width="90px" Height="24px" />
