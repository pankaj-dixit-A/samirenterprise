    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (hdnfClosePopup.Value == "txtPURCNO")
            {
                ...
                //    " Bill_Amount,NETQNTL as Quantal,Year_Code,prid from " +
                //   " qrysugarpurchasereturnhead where Company_Code=" + Convert.ToInt32(Session["Company_Code"].ToString())
            ...
            if (strTextBox == "txtPURCNO")
            {
                if (txtPURCNO.Text != string.Empty)
                {
                    ...
                    qry = "select doc_no,Tran_Type,PURCNO,Convert(varchar(10),doc_date,103) as doc_date,Ac_Code,Ac_Name_E as Party,Unit_Code,unitname AS Unit_Name," +
                        ...
                        "qrysugarpurchasereturnhead  where doc_no=" + txtPURCNO.Text + " and Company_Code=" + Convert.ToInt32(Session["Company_Code"].ToString()) + " and Year_Code=" + hdnfyearcode.Value;
