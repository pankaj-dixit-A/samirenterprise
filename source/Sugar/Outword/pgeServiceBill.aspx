...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function EInovice() {
            ...
            window.open('../Utility/pgeEInovice.aspx?dono=' + dono + '&Type=RB&ID=' + ID);
        }
        function Confirm() {
        ...
        function pagevalidation() {
            ...
            try {
                ...
                XML = XML + "<ServiceBillHead " + DOCNO + " Customer_Code='" + AC_CODE + "' GstRateCode='" + GSTRateCode + "' Subtotal='" + SUBTOTAL + "' " +
                        ...
                        "cc='" + ac + "' ta='" + ta + "' rbid='" + rbid + "' TCS_Rate='" + TCS_Rate + "' TCS_Amt='" + TCS_Amt + "' TCS_Net_Payable='" + TCS_Net_Payable + "' einvoiceno='" + einvoiceno + "' ackno='" + ackno + "'>";
