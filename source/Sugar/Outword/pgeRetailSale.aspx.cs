...
public partial class pgeRetailSale : System.Web.UI.Page
{
    ...
    protected void btnAdddetails_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            dr["mc"] = mc;
            Int32 PD_ID = Convert.ToInt32(clsCommon.getString("select isnull(purchasedetailid,0) as purchasedetailid from nt_1_sugarpurchasedetails where doc_no=" + txtPurc_No.Text + "  and Company_Code=" + Convert.ToInt32(Session["Company_Code"].ToString()) + " and Year_Code=" + Session["year"].ToString() + ""));
            dr["PD_ID"] = PD_ID;
            #endregion
            if (btnAdddetails.Text == "ADD")
            {
    ...
    private void AmtCalculation()
    {
        ...
        //    {
        //        txtTCS_Rate.Text = hdnfTCSRate.Value;
        //    }
        //    else
        //    {
        //        txtTCS_Rate.Text = "0.000";
        //    }
