...
function SelectRow(CurrentRow, RowIndex) {
    ...
    <script type="text/javascript">
        ...
        function EInovice() {
            ...
            window.open('../Utility/pgeEInovice.aspx?dono=' + dono + '&Type=RS&ID=' + ID);
        }
        function GEway() {
            var dono = document.getElementById('<%=txtDOC_NO.ClientID %>').value;
            var ID = document.getElementById('<%=hdnf.ClientID %>').value;
            window.open('../Utility/pgeEwayBill.aspx?dono=' + dono + '&Type=RS&ID=' + ID);
        }
    </script>
    <script type="text/javascript">
        ...
        function pagevalidation() {
            ...
            XML = XML + "<SaleReturnHead " + DOCNOC + " PurcTranType='' doc_date='" + DOC_DATE + "' Ac_Code='" + AC_CODE + "' Unit_Code='" + Unit_Code + "' " +
               ...
               "Eway_Bill_No='" + EwayBill_No + "' TCS_Rate='" + TCS_Rate + "' TCS_Amt='" + TCS_Amt + "' TCS_Net_Payable='" + TCS_Net_Payable + "' einvoiceno='" + einvoiceno + "' ackno='" + ackno + "' TDS_Rate='" + TDS_Rate + "' TDS_Amt='" + TDS_Amt + "'>";
